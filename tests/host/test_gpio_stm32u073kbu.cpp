...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073KBU (128-KB UFQFPN32) GPIO model.
//
// The STM32U073KBU bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073KBUCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073KBUCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073KBUCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073KBUInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073KBUInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073KBUInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073KBUWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073KBUWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073KBUWiringTest, BsrrAddressMatchesHardwareBase) {
