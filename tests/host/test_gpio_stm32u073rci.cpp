...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073RCI GPIO model.
//
// The STM32U073RCI bonds out GPIOA, GPIOB, GPIOC, GPIOD (PD2 only) and GPIOF
...
class GpioStm32u073RCICapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073RCICapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RCICapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073RCIInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073RCIInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073RCIInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073RCIWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073RCIWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RCIWiringTest, BsrrAddressMatchesHardwareBase) {
