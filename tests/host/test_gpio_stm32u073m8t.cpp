...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073M8T (LQFP80) GPIO model.
//
...
class GpioStm32u073M8TCapabilityTest : public ::testing::TestWithParam<CapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073M8TCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073M8TCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073M8TInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073M8TInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073M8TInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073M8TWiringTest : public ::testing::TestWithParam<WiringCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073M8TWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073M8TWiringTest, BsrrAddressMatchesHardwareBase)
{
