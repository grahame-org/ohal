...
// This file validates that the C6U per-package wrapper header compiles
// and wires correctly.
// ---------------------------------------------------------------------------
...
class GpioStm32u031C6UCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u031C6UCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031C6UCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u031C6UInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u031C6UInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u031C6UInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u031C6UWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u031C6UWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031C6UWiringTest, BsrrAddressMatchesHardwareBase) {
