...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073MCI (81-ball UFBGA) GPIO model.
//
// The STM32U073MCI bonds out GPIOA, GPIOB, GPIOC, GPIOD (bits 0-6 and 8-13),
...
class GpioStm32u073MciTest : public ::testing::Test
{
  protected:
    void SetUp() override
    {
...
TEST_F(GpioStm32u073MciTest, Set_WritesBitToBsrr)
{
    MockPin5::set();
    EXPECT_EQ(mock_bsrr, 1U << 5U);
}

TEST_F(GpioStm32u073MciTest, Clear_WritesBsrrResetBit)
{
    MockPin5::clear();
    EXPECT_EQ(mock_bsrr, 1U << 21U);
}

TEST_F(GpioStm32u073MciTest, SetMode_Output_WritesModerBits)
{
    MockPin5::set_mode(ohal::gpio::PinMode::Output);
    EXPECT_EQ(mock_moder & (0b11U << 10U), 0b01U << 10U);
}

TEST_F(GpioStm32u073MciTest, SetMode_Input_WritesModerBits)
{
...
TEST_F(GpioStm32u073MciTest, ReadInput_ReturnsHigh_WhenIdrBitSet)
{
    mock_idr = 1U << 5U;
    EXPECT_EQ(MockPin5::read_input(), ohal::gpio::Level::High);
}

TEST_F(GpioStm32u073MciTest, PortSet_WritesMaskToBsrrLow16Bits)
{
    MockPort::set(0x00FFU);
    EXPECT_EQ(mock_bsrr, 0x00FFU);
}

TEST_F(GpioStm32u073MciTest, PortClear_WritesMaskToBsrrHigh16Bits)
{
    MockPort::clear(0x00FFU);
    EXPECT_EQ(mock_bsrr, 0x00FF0000U);
}

TEST_F(GpioStm32u073MciTest, PortWrite_CombinesSetAndClearMasksInSingleBsrrWrite)
{
...
class GpioStm32u073MciCapabilityTest : public ::testing::TestWithParam<CapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073MciCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073MciCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073MciInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073MciInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073MciInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073MciWiringTest : public ::testing::TestWithParam<WiringCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073MciWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073MciWiringTest, BsrrAddressMatchesHardwareBase)
{
