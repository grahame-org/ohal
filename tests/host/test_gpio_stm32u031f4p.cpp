...
// This file validates that the F4P per-package wrapper header compiles
// and wires correctly.
// ---------------------------------------------------------------------------
...
class GpioStm32u031F4PCapabilityTest : public ::testing::TestWithParam<CapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u031F4PCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031F4PCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u031F4PInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u031F4PInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u031F4PInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u031F4PWiringTest : public ::testing::TestWithParam<WiringCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u031F4PWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031F4PWiringTest, BsrrAddressMatchesHardwareBase)
{
