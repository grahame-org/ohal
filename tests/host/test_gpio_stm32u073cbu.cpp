...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073CBU (128-KB UFQFPN48) GPIO model.
//
// The STM32U073CBU bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073CBUCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073CBUCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CBUCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073CBUInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073CBUInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073CBUInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073CBUWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073CBUWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CBUWiringTest, BsrrAddressMatchesHardwareBase) {
