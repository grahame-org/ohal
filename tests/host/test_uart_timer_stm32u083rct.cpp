...
class Stm32u083RctUartCoverageTest : public ::testing::TestWithParam<BoolCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    TestProjectUartCoverage, Stm32u083RctUartCoverageTest,
    ::testing::Values(
        BoolCase{
        ...
        BoolCase{
            ohal::gpio::capabilities::supports_output_type<ohal::gpio::PortA, 5>::value,
            "TestProjectLedPinSupportsOutput"}),
    [](const ::testing::TestParamInfo<BoolCase>& info) { return info.param.name; });
// clang-format on

TEST_P(Stm32u083RctUartCoverageTest, ValueIsTrue) { EXPECT_TRUE(GetParam().value); }

class Stm32u083RctTimerCoverageTest : public ::testing::TestWithParam<BoolCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    Tim2ChannelCoverage, Stm32u083RctTimerCoverageTest,
    ::testing::Values(
        BoolCase{
        ...
        BoolCase{
            ...
            "Channel3MapsToCcr4"},
        BoolCase{
            ohal::timer::Channel<Tim2, 0>::Egr::access == ohal::core::Access::WriteOnly,
            "Tim2EgrIsWriteOnly"}),
    [](const ::testing::TestParamInfo<BoolCase>& info) { return info.param.name; });
// clang-format on

TEST_P(Stm32u083RctTimerCoverageTest, ValueIsTrue) { EXPECT_TRUE(GetParam().value); }
