...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U031F8P (TSSOP20) GPIO model.
//
...
class GpioStm32u031F8PCapabilityTest : public ::testing::TestWithParam<CapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u031F8PCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031F8PCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u031F8PInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u031F8PInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u031F8PInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u031F8PWiringTest : public ::testing::TestWithParam<WiringCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u031F8PWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031F8PWiringTest, BsrrAddressMatchesHardwareBase)
{
