...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073HCY (256-KB WLCSP42) GPIO model.
//
// The STM32U073HCY bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073HCYCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073HCYCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073HCYCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073HCYInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073HCYInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073HCYInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073HCYWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073HCYWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073HCYWiringTest, BsrrAddressMatchesHardwareBase) {
