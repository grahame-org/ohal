...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073CCU (256-KB UFQFPN48) GPIO model.
//
// The STM32U073CCU bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073CCUCapabilityTest : public ::testing::TestWithParam<CapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073CCUCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CCUCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073CCUInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073CCUInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073CCUInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073CCUWiringTest : public ::testing::TestWithParam<WiringCase>
{
};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073CCUWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CCUWiringTest, BsrrAddressMatchesHardwareBase)
{
