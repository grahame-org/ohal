// Negative-compile test: calling set_output_type() on an MSP430FR2355 GPIO pin must be
// rejected at compile time because the platform does not support configurable output type.
// Expected static_assert: "ohal: MSP430FR2355 GPIO does not support configurable output type."
...
void test()
{
    // NOLINTNEXTLINE — intentional: triggers "does not support configurable output type"
    Pin2::set_output_type(ohal::gpio::OutputType::OpenDrain);
}
