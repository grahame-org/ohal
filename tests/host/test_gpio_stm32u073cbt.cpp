...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073CBT (128-KB LQFP48) GPIO model.
//
// The STM32U073CBT bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073CBTCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073CBTCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CBTCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073CBTInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073CBTInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073CBTInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073CBTWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073CBTWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CBTWiringTest, BsrrAddressMatchesHardwareBase) {
