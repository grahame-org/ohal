...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073CCT (256-KB LQFP48) GPIO model.
//
// The STM32U073CCT bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073CCTCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073CCTCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CCTCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073CCTInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073CCTInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073CCTInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073CCTWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073CCTWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073CCTWiringTest, BsrrAddressMatchesHardwareBase) {
