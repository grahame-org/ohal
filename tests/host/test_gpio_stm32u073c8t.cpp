...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073C8T (64-KB LQFP48) GPIO model.
//
// The STM32U073C8T bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073C8TCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073C8TCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073C8TCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073C8TInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073C8TInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073C8TInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073C8TWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073C8TWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073C8TWiringTest, BsrrAddressMatchesHardwareBase) {
