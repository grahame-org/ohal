...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073H8Y (64-KB WLCSP42) GPIO model.
//
// The STM32U073H8Y bonds out GPIOA, GPIOB, GPIOC and GPIOF;
...
class GpioStm32u073H8YCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073H8YCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073H8YCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073H8YInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073H8YInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073H8YInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073H8YWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073H8YWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073H8YWiringTest, BsrrAddressMatchesHardwareBase) {
