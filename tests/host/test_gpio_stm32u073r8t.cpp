...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073R8T GPIO model.
//
// The STM32U073R8T bonds out GPIOA, GPIOB, GPIOC, GPIOD (PD2 only) and GPIOF
...
class GpioStm32u073R8TCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073R8TCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073R8TCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073R8TInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073R8TInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073R8TInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073R8TWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073R8TWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073R8TWiringTest, BsrrAddressMatchesHardwareBase) {
