...
// This file validates that the K6U per-package wrapper header compiles
// and wires correctly.
// ---------------------------------------------------------------------------
...
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u031K6UCapabilityTest,
    ::testing::Values(
...
// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u031K6UInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u031K6UInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u031K6UWiringTest,
    ::testing::Values(
