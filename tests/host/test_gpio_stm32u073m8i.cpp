...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073M8I (UFBGA81) GPIO model.
//
...
class GpioStm32u073M8ICapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073M8ICapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073M8ICapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073M8IInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073M8IInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073M8IInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073M8IWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073M8IWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073M8IWiringTest, BsrrAddressMatchesHardwareBase) {
