...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073RBT GPIO model.
//
// The STM32U073RBT bonds out GPIOA, GPIOB, GPIOC, GPIOD (PD2 only) and GPIOF
...
class GpioStm32u073RBTCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073RBTCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RBTCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073RBTInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073RBTInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073RBTInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073RBTWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073RBTWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RBTWiringTest, BsrrAddressMatchesHardwareBase) {
