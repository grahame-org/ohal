...
// ---------------------------------------------------------------------------
// Host-side tests for the STM32U073RBI GPIO model.
//
// The STM32U073RBI bonds out GPIOA, GPIOB, GPIOC, GPIOD (PD2 only) and GPIOF
...
class GpioStm32u073RBICapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u073RBICapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RBICapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u073RBIInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u073RBIInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u073RBIInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u073RBIWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u073RBIWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u073RBIWiringTest, BsrrAddressMatchesHardwareBase) {
