...
// This file validates that the C6T per-package wrapper header compiles
// and wires correctly.
// ---------------------------------------------------------------------------
...
class GpioStm32u031C6TCapabilityTest : public ::testing::TestWithParam<CapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    BondedPortCapabilities, GpioStm32u031C6TCapabilityTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031C6TCapabilityTest, CapabilityIsTrue) { EXPECT_TRUE(GetParam().value); }
...
class GpioStm32u031C6TInvalidCapTest : public ::testing::TestWithParam<InvalidCapCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    UnbondedAndOutOfRangeCapabilities, GpioStm32u031C6TInvalidCapTest,
    ::testing::Values(
        InvalidCapCase{
...
TEST_P(GpioStm32u031C6TInvalidCapTest, CapabilityIsFalse) { EXPECT_FALSE(GetParam().value); }
...
class GpioStm32u031C6TWiringTest : public ::testing::TestWithParam<WiringCase> {};

// clang-format off
INSTANTIATE_TEST_SUITE_P(
    PortBsrrAddresses, GpioStm32u031C6TWiringTest,
    ::testing::Values(
...
TEST_P(GpioStm32u031C6TWiringTest, BsrrAddressMatchesHardwareBase) {
