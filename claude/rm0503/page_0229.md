...
See _Section 7.4.5: GPIO port input data register (GPIOx_IDR) (x = A to F)_ and
_Section 7.4.6: GPIO port output data register (GPIOx_ODR) (x = A to F)_ for the register
descriptions.
