...
_This register is write protected. The write access procedure is described in RTC register write protection on page 914._
...
| OUT2EN | TAMPALRM_TYPE | TAMPALRM_PU | ALRBFCLR | ALRAFCLR | TAMPOE | TAMPTS | ITSE | COE | OSEL[1:0] |     | POL | COSEL | BKP | SUB1H | ADD1H |
| ------ | ------------- | ----------- | -------- | -------- | ------ | ------ | ---- | --- | --------- | --- | --- | ----- | --- | ----- | ----- |
| rw     | rw            | rw          | rw       | rw       | rw     | rw     | rw   | rw  | rw        | rw  | rw  | rw    | rw  | w     | w     |

| TSIE | WUTIE | ALRBIE | ALRAIE | TSE | WUTE | ALRBE | ALRAE | SSRUIE | FMT | BYPSHAD | REFCKON | TSEDGE | WUCKSEL[2:0] |     |     |
| ---- | ----- | ------ | ------ | --- | ---- | ----- | ----- | ------ | --- | ------- | ------- | ------ | ------------ | --- | --- |
| rw   | rw    | rw     | rw     | rw  | rw   | rw    | rw    | rw     | rw  | rw      | rw      | rw     | rw           | rw  | rw  |
