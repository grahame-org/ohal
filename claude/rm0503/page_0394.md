...
_Note:_
_The DAC trigger must be enabled for triangle wave generation by setting the TEN1 bit in the_
_DAC_CR register._

_The MAMP1[3:0] bits must be configured before enabling the DAC, otherwise they cannot_
_be changed._
