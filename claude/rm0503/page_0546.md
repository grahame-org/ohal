...
The AES*KEYRx registers may be written only when KEYSIZE value is correct and when the AES
...
Refer to \_Section 22.4.14: AES key registers on page 537* for more details.
