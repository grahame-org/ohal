...
*Figure 218* gives an example of counter operation, showing count signal generation and
...
*Figure 219* gives an example of counter behavior when TI1FP1 polarity is inverted (same
