...
Downcounting is active when DIR bit in TIMx_CR1 register is high. Refer to _Downcounting mode on page 661_.
...
Center-aligned mode is active when the CMS bits in TIMx*CR1 register are different from
...
\_Center-aligned mode (up/down counting) on page 664*.

_Figure 212_ shows some center-aligned PWM waveforms in an example where:
