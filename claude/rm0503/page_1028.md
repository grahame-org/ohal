...
_Note:_
_If the sequence has not completed, the start bit detection aborts and the receiver returns to_
_the idle state (no flag is set), where it waits for a falling edge._
