...
_Note:_ _PVMO4 is cleared when PVM4 is disabled (PVME4 = 0). After enabling PVM4, the_
_PVM4 output is valid after the PVM4 wake-up time._
...
_Note:_ _PVMO3 is cleared when PVM3 is disabled (PVME3 = 0). After enabling PVM3, the_
_PVM3 output is valid after the PVM3 wake-up time._
...
_Note:_ _PVMO1 is cleared when PVM1 is disabled (PVME1 = 0). After enabling PVM1, the_
_PVM1 output is valid after the PVM1 wake-up time._
_This bit is available only on the STM32U0x3xx devices._
