...
1. The effects of internal tamper detection in confirmed mode is described with tamp_confirmed signal in *Table 181: TAMP*
   *interconnection*
2. The effects of internal tamper detection in potential mode is described with tamp_potential signal in *Table 181: TAMP*
   *interconnection*.
