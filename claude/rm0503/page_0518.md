...
For more information on data swapping, refer to _Section 22.4.13: AES data registers and_
_data swapping_.

#### ECB/CBC encryption sequence

The sequence of events to perform an ECB/CBC encryption (more detail in _Section 22.4.4_):
...
9. Repeat steps _6_-_7_-_8_ to process all the blocks with the same encryption key.
