...
_Figure 169_ shows the behavior of the OCxREF signal when the ETRF Input becomes High,
...
_Note: In case of a PWM with a 100% duty cycle (if CCRx>ARR), then OCxREF is enabled again at the next counter overflow._
