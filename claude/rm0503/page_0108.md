...
1. Enable the power interface clock by setting the PWREN bits in the _Section 5.2.18:_
   _Peripheral clock enable registers_
...
to _Section 5.2.9: Clock source frequency versus voltage scaling_ and to _Section 3.3.3:_
_FLASH read access latency_.
