...
1. Enable the power interface clock by setting the PWREN bits in the Section 5.2.18:
...
to Section 5.2.9: Clock source frequency versus voltage scaling and to Section 3.3.3:
