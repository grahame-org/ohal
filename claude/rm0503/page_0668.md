...
- Internal trigger inputs (ITRx): using one timer as prescaler for another timer, for
  example, Timer X can be configured to act as a prescaler for Timer Y. Refer to \*: Using one timer as prescaler for another timer on page 693\_ for more details.
