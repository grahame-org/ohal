...
The Shutdown mode is entered according _Entering low-power mode_, when the

SLEEPDEEP bit in the Cortex®-M0+ System Control register is set.

Refer to _Table 30: Shutdown mode_ for details on how to enter Shutdown mode.
...
The Shutdown mode is exit according _Section : Exiting low-power mode_. A power-on reset
...
Refer to _Table 30: Shutdown mode_ for more details on how to exit Shutdown mode.
