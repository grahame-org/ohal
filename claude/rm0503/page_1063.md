...
_Note:_
_Before entering low-power mode, make sure that no USART transfers are ongoing._
...
_reenabled when exiting from low-power mode._
...
_Note:_
_When FIFO management is enabled, mute mode can be used with wake-up from low-power_
