...
shift operation is pending (when SHPF = 1, in RTC*ICSR).
...
\_Note:* \_Writing to SUBFS causes RSF to be cleared. Software can then wait until RSF = 1 to be sure that the shadow registers have been updated with the shifted time.\_
