...
to CC1P description.
_Note:_ _This bit is not writable as soon as LOCK level 2 or 3 has been programmed (LOCK bits_
...
for details.
_Note:_ _On channels having a complementary output, this bit is preloaded. If the CCPC bit is_
