...
- external clock (external clock mode 2, see \_Section 23.3.5\*)
- trigger for the slave mode (see \_Section 23.3.26\*)
- PWM reset input for cycle-by-cycle current regulation (see \_Section 23.3.7\*)
