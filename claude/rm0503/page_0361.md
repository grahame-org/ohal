...
_Note:_
_Care must be taken when using high shifting values. This reduces the comparison range._
...
*comparison is done between ADC_DR[11:4] and HT *x*[7:0] / LT *x*[[7:0], and HT *x*[11:8] /*
*LT *x*[11:8] must be kept reset.*
