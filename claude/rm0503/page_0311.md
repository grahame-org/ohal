...
| CPU_interruptenableIMn_of_EXTI_IMR | CPU_event_enableEMn_of_EXTI_EMR | Configurableevent_inputsRPIFn_ofEXTI_RPR,FPIFn_ofEXTI_FPR | exti(n) interrupt(1) | CPU event | CPU wake-up |
| ---------------------------------- | ------------------------------- | --------------------------------------------------------- | -------------------- | --------- | ----------- |
