...
| CPU interrupt enable IMn of EXTI IMR \_ | CPU event enable EMn of EXTI EMR \_ | Configurable event inputs RPIFn of EXTI RPR, _ FPIFn of EXTI FPR _ | exti(n) interrupt(1) | CPU event | CPU wake-up |
| --------------------------------------- | ----------------------------------- | ------------------------------------------------------------------ | -------------------- | --------- | ----------- |
