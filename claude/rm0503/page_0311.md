...
| CPU interrupt enable IMn of EXTI IMR | CPU event enable EMn of EXTI EMR | Configurable event inputs RPIFn of EXTI RPR, \_ FPIFn of EXTI FPR | exti(n) interrupt(1) | CPU event | CPU wake-up |
| ------------------------------------ | -------------------------------- | ----------------------------------------------------------------- | -------------------- | --------- | ----------- |
