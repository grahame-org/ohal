...
_Note:_
_Like for CBC mode, the AES_IVRx registers must be reloaded during the resume operation._
...
GCM chaining is defined in NIST _Special Publication 800-38D, Recommendation for Block_
