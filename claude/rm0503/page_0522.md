...
6. Append data in AES, and read the result. The three possible scenarios are described in
   *Section 22.4.4: AES procedure to perform a cipher operation*.
...
sequence is described in *Section 22.4.8: AES basic chaining modes (ECB, CBC)*.
...
construction in GCM mode is given in *Figure 112*.
