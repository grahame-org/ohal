...
buffer swapping too (Refer to _Section 37.5.3: Double-buffered endpoints and usage in_
_Device mode_).
...
- Device mode
  ...
  the status based on buffer availability condition (Refer to _Section 37.5.3: Double-buffered_
