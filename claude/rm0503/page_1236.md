...
transmitted (refer to *Section 37.5.5: Isochronous transfers in Device mode*). Hardware
...
- Device mode
  These bits contain the information about the endpoint status, listed in *Table 235*. These bits
  ...
  the status based on buffer availability condition (Refer to *Section 37.5.3: Double-buffered*
...
- Host mode
  The STATTX bits contain the information about the channel status. Refer to *Table 235* for the
