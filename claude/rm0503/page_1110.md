...
| --------------- | ----------- | -------------------------- |
| LPUART RX       | Input       | Serial data receive input. |
| LPUART TX       | Output      | Transmit data output.      |
| LPUART CTS      | Input       | Clear to send              |
| LPUART RTS      | Output      | Request to send            |
...
| ------------- | ----------- | ----------------------------------- |
| lpuart pclk   | Input       | APB clock                           |
| lpuart ker ck | Input       | LPUART kernel clock                 |
| lpuart wkup   | Output      | LPUART provides a wake-up interrupt |
