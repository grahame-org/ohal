...
| --------------- | ----------- | -------------------------- |
| LPUART RX \_    | Input       | Serial data receive input. |
| LPUART TX \_    | Output      | Transmit data output.      |
| LPUART CTS \_   | Input       | Clear to send              |
| LPUART RTS \_   | Output      | Request to send            |
| LPUART DE(1) \_ | Output      | Driver enable              |
...
| ------------------- | ----------- | ----------------------------------- |
| lpuart pclk \_      | Input       | APB clock                           |
| lpuart ker ck \_ \_ | Input       | LPUART kernel clock                 |
| lpuart wkup \_      | Output      | LPUART provides a wake-up interrupt |
