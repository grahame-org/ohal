...
*Table 143: Output control bits for complementary OCx and OCxN channels with break*
*feature  (TIM16/17) on page 816* for more details. In particular, the dead-time is activated
