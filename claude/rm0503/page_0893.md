...
0111: divider / 512
Others: divider / 1024
*Note:* *Reading this register returns the prescaler value from the V **DD **voltage domain. This*
...
reload value.
*Note:* *Reading this register returns the reload value from the V **DD **voltage domain. This value*
