...
Prefetch is enabled by setting the PRFTEN bit of the _FLASH access control register (FLASH_ACR)_. This feature is useful if at least one wait state is needed to access the flash
memory.
