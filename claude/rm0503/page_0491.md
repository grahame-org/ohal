...
RNG_HTCR (configuration A in \_Section 21.6.2\*).
...
- Supported by restarting the entropy source and rerunning the startup tests (see
  software reset sequence in _Section 21.3.4\*). Other kinds of on-demand testing
  (software based) are_not supported_.
