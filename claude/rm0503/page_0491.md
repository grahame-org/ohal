...
_Note:_
_An interrupt can be generated when an error is detected._

_Above the health test thresholds are modified by changing the value in the RNG_HTCR_
_register. See **Section 21.6 **for details._
