...
| -------------------- | ------------- | ------------------ |
| crs sync in 0        | Digital input | SYNC signal source |
| crs sync in 1        |               |                    |
| crs sync in 2        |               |                    |
| crs sync in 3        |               |                    |
...
| -------------------- | ------------------------------------------------ |
| crs sync in 0        | GPIO selected as SYNC signal source              |
| crs sync in 1        | LSE selected as SYNC signal source               |
| crs sync in 2        | USB SOF selected as SYNC signal source (default) |
| crs sync in 3        | Reserved                                         |
