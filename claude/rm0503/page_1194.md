...
_Note:_ _The BSY flag must be used with caution: refer to **Section 36.4.10: SPI status flags **and_
...
_(MODF) on page 1184_ for the software sequence.
...
_Note:_ _Data is always right-aligned. Unused bits are ignored when writing to the register, and_
