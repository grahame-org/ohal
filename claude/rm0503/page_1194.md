...
*Note:* *The BSY flag must be used with caution: refer to **Section 36.4.10: SPI status flags **and*

*Procedure for disabling the SPI on page 1174**.*
...
*(MODF) on page 1184* for the software sequence.
...
*Section 36.4.9: Data transmission and reception procedures*).
