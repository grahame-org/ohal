...
This configuration is used by RNG to configure the health tests. See _Section 21.6: RNG entropy source validation_ for the recommended value.
\_Note:_ \_The RNG behavior, including the read to this register, is not guaranteed if a different value from the recommended value is written._
