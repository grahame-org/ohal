...
This bit is controlled by software (if not locked). It selects the signal for COMP1*INP input of
the comparator 1:
0: Signal selected with INPSEL[2:0] bitfield of this register
1: COMP2_INP signal of the comparator 2 (required for window mode, see \_Figure 67*)
...
input COMP1*INP of the comparator 1 (also see the WINMODE bit):
Refer to \_Table 89: COMP1 noninverting input assignment*.
...
input COMP1*INM of the comparator 1:
Refer to \_Table 90: COMP1 inverting input assignment*.
