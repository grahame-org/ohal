...
_Note:_ _The channels selected through ADC_AWD3CR must be also configured into the_
...
- Just after a calibration is complete, DATA[6:0] contains the calibration factor.
  _Note:_ _Software can write these bits only when ADEN=1 (ADC is enabled and no calibration is ongoing_
