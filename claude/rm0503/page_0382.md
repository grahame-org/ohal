...
_Note:_ _The channels selected through ADC_AWD3CR must be also configured into the ADC_CHSELR registers. The software is allowed to write this bit only when ADEN = 0._
...
- Just after a calibration is complete, DATA[6:0] contains the calibration factor.
  \_Note:_ \_Software can write these bits only when ADEN=1 (ADC is enabled and no calibration is ongoing and no conversion is ongoing)._
