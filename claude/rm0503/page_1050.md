...
This section is relevant only when smartcard mode is supported. Refer to Section 34.4:
...
Figure 343 shows examples of what can be seen on the data line with and without parity
error.
