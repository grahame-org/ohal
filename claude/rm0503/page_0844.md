...
_Note:_
_After a write to the LPTIM_RCR register, a new write operation to the same register can only_
_be performed when the previous write operation is completed. Any successive writes before_
_the REPOK flag is set, lead to unpredictable results._
