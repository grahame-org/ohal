...
power mode (LPRun, LPSleep or Stop mode). Refer to _Section : ADC voltage regulator disable sequence_).

_Note: When the internal voltage regulator is disabled, the internal analog calibration is kept._
