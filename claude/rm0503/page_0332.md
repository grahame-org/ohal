...
power mode (LPRun, LPSleep or Stop mode). Refer to _Section : ADC voltage regulator_
_disable sequence_).

_Note:_
_When the internal voltage regulator is disabled, the internal analog calibration is kept._
