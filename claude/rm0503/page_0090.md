...
value different from 0xFFFF FFFF before programming, except if the data to write is 0x0000
0000.
...
Do not write this register as long as CFGBSY in *FLASH status register (FLASH_SR)* is high,
