...
overrun/underrun error occurs. It is cleared by software by setting the OVRCF bit _. Note: This bit is cleared by hardware when PE = 0._
...
is cleared by software when NBYTES is written to a non-zero value _. Note: This bit is cleared by hardware when PE = 0. This flag is only for controller mode, or for target mode when the SBC bit is set._
