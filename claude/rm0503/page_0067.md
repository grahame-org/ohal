...
1. Program the new number of wait states to the LATENCY bits of the _FLASH access_
   _control register (FLASH_ACR)_.
2. Check that the new number of wait states is taken into account to access the flash
   ...
   _(FLASH_ACR)_, and wait until the programmed new number is read.
...
4. Program the new number of wait states to the LATENCY bits of the _FLASH access_
   _control register (FLASH_ACR)_.
