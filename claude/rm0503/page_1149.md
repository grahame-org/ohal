...
_Note: It is forbidden to write values lower than 0x300 in the LPUART_BRR register._

_Provided that LPUART_BRR must be ≥ 0x300 and LPUART \_BRR is 20 bits, a care must be taken when generating high baud rates using high lpuart_ker_ck_pres values. lpuart_ker_ck_pres must be in the range [3 x baud rate..4096 x baud rate]._
