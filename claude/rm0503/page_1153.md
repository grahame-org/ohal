...
software, by writing 1 to the CTSCF bit in the LPUART*ICR register.
...
LPUART*TDR. Every write in the LPUART_TDR places the data in the TXFIFO. This flag
...
\_Note:* \_This bit is used during single buffer transmission.\_

#### Bit 6 TC: Transmission complete

This bit indicates that the last data written in the LPUART*TDR has been transmitted out of
the shift register.
