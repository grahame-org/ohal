...
the lpuart_ker_ck clock source can be configured in the RCC (see _Section Reset and clock controller (RCC)_). Otherwise, the lpuart_ker_ck is the same as lpuart_pclk.
