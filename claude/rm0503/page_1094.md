...
_Note:_ _If the USART does not support LIN mode, this bit is reserved and kept at reset value._
...
_Note:_ _The TXFNF is kept reset during the flush request until TXFIFO is empty. After sending_
