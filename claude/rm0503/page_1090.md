...
\_Note:* _In FIFO mode, the TXFNF flag is reset during the flush request until TxFIFO is empty in_
...
\_Note:* _If the USART does not support the auto baud rate feature, this bit is reserved and must_
