...
_Note:_ _This value can be programmed after the start of the block reception (using the data_
...
_Note:_
_RTOR can be written on-the-fly. If the new value is lower than or equal to the counter, the_
_RTOF flag is set._

_This register is reserved and forced by hardware to “0x00000000” when the receiver timeout_
_feature is not supported. Refer to **Section 34.4: USART implementation**._
