...
_Note:_
_The digital filters sensitivity is controlled by groups. It is not possible to configure each digital_
...
_Note:_
_In case no internal clock signal is provided, the digital filter must be deactivated by setting_
_the CKFLT, ICxF and TRGFLT bits to 0. In this case, an external analog filter can be used to_
