...
_Note:_
_The TE bit must be set before writing the data to be transmitted to the USART_TDR._
...
low bits (when M[1:0] = 10) followed by 2 stop bits (see _Section 34.5.1: USART block_
_diagram_). It is not possible to transmit long breaks (break of length greater than 9/10/11 low
bits).
