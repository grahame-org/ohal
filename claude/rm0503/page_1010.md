...
*Note:* *t **SCLDEL **is used to generate t **SU:DAT **timing.*
...
*Note:* *SDADEL is used to generate t **HD:DAT **timing.*
...
*Note:* *SCLH is also used to generate t **SU:STO **and t **HD:STA* *timing.*
...
*Note:* *SCLL is also used to generate t **BUF **and t **SU:STA* *timings.*
