...
and hold counters (refer to section \_I2C timings*), and for SCL high and low level counters
(refer to section \_I2C controller initialization*).
...
_Note:\* \_SCLH is also used to generate t **SU:STO **and t \*\*HD:STA_ _timing._
...
_Note:\* \_SCLL is also used to generate t **BUF **and t \*\*SU:STA_ _timings._

_Note: This register must be configured when the I2C peripheral is disabled (PE = 0)._

_Note: The STM32CubeMX tool calculates and provides the I2C_TIMINGR content in the I2C Configuration window._
