...
resolution. An internal reference can also be set on the same input. Refer to _voltage_
_reference buffer (VREFBUF)_ section.
...
The DAC main features are the following (see _Figure 58: DAC block diagram_)
