...
|                                                                  |                                  |                                  |                                  |                              |
| ---------------------------------------------------------------- | -------------------------------- | -------------------------------- | -------------------------------- | ---------------------------- |
| Software configures DMA to send 3 data blocks and enables LPUART | DMA writes F1 into LPUART \_ TDR | DMA writes F2 into LPUART \_ TDR | DMA writes F3 into LPUART \_ TDR | The DMA transfer is complete |
