...
selected, the switch occurs when the clock source becomes ready. Status bits in the _Internal_
_clock sources calibration register (RCC_ICSCR)_ indicate which clock(s) is (are) ready and
