...
_Note:_
_The GNBREQ field value can be written by software only when the enable GE bit of the_
...
_Note:_
_The request generator channel x must be disabled (DMAMUX_RGxCR.GE = 0) when the_
...
| ---------------- | --------------------------------------------------------------------------------- | ---------- | --------- | ---------- |
| dmamuxovr it \_  | Synchronization event overrun on channel x of the DMAMUX request line multiplexer | SOFx       | CSOFx     | SOIE       |
