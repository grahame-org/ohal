...
_Note:_ _In BCD mode (BIN=00)The overflow bits of the synchronous counter (bits 15) is never_
_compared. This bit can be different from 0 only after a shift operation._
