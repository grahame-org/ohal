...
\_Note:_ \_When the wake-up timer is disabled, wait for WUTWF = 1 before enabling it again._
...
0: Calendar values (when reading from RTC*SSR, RTC_TR, and RTC_DR) are taken from
...
\_Note:* \_If the frequency of the APB clock is less than seven times the frequency of RTCCLK, BYPSHAD must be set to 1.\_

#### Bit 4 REFCKON: RTC_REFIN reference clock detection enable (50 or 60 Hz)

0: RTC*REFIN detection disabled
1: RTC_REFIN detection enabled
\_Note:* _BIN must be 0x00 and PREDIV_S must be 0x00FF._
