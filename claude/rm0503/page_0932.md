...
_Note: If the frequency of the APB clock is less than seven times the frequency of RTCCLK, BYPSHAD must be set to 1._
...
_Note: BIN must be 0x00 and PREDIV_S must be 0x00FF._
