...
_Note:_ _SSRUF is not an error event as SSR counter is a free-running down-counter with_
_automatic reload._
...
_Note:_ _TSF is not set if TAMPTS = 1 and the tamper flag is read during the 3 ck_apre cycles_
_following tamper event. Refer to **Timestamp on tamper event **for more details._
