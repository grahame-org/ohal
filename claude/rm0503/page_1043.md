...
This section is relevant only when LIN mode is supported. Refer to *Section 34.4: USART*
*implementation*.
...
The procedure described in *Section 34.5.5* has to be applied for LIN master transmission. It
...
The behavior of the break detector state machine and the break flag is shown in *Figure 337*.

Examples of break frames are given in *Figure 338*.
