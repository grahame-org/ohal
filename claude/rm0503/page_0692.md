...
_Figure 224: Master/Slave timer example_ and _Figure 225: Master/slave connection example with 1 channel only timers_ present an overview of the trigger selection and the master mode
selection blocks.
