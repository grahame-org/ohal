...
channels/endpoints and only DATA0 packet are transmitted (Refer to _Section 37.5.5: Isochronous transfers in Device mode_). Hardware toggles this bit just after the end of data
