...
_Note: The DMAEN bit in the ADC_CFGR1 register must be set after the ADC calibration phase._
...
DMA transfer (when a transfer complete interrupt occurs, see _Section 9: Direct memory access controller (DMA) on page 265_) even if a conversion has been started again.
