...
(refer to Section 14.6.2: ADC overrun (OVR, OVRMOD) on page 349).
...
DMA transfer (when a transfer complete interrupt occurs, see Section 9: Direct memory
access controller (DMA) on page 265) even if a conversion has been started again.
