...
\_Note:_ \_t **DTS**= 1/f **DTS**, t **CK_INT**= 1/f **CK_INT**._
...
\_Note:_ \_Switch from edge-aligned mode to center-aligned mode as long as the counter is enabled (CEN=1) is not allowed_
