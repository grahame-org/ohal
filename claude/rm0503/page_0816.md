...
| 1            | X        | X        | 0        | 0         | Output Disabled (not driven by the timer: Hi-Z) OCx=0 OCxN=0, OCxN EN=0 \_                                                                                                                                                                       |                                                                         |
...
|              |          | 1        | 1        | 0         | OCxREF + Polarity OCx=OCxREF XOR CCxP, OCx EN=1 \_                                                                                                                                                                                               | Off-State (output enabled with inactive state) OCxN=CCxNP, OCxN EN=1 \_ |
...
_Note:_
_The state of the external I/O pins connected to the complementary OCx and OCxN channels_
_depends on the OCx and OCxN channel state and GPIO control and alternate function_
_registers._
