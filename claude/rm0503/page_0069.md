...
*Note: The FLASH*CR register cannot be written when the BSY1 bit of the \**FLASH status register\*
\*(FLASH*SR)\*\*is set. Any attempt to write to this register with the BSY1 bit set causes the AHB bus to stall until the BSY1 bit is cleared.\*
