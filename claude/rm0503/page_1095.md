...
\_Note:* _When this bit is set, the USART_RDR register content is not lost but the shift register is_
...
_bit to 1 to increase the USART tolerance to deviations (Refer to \*\*Section 34.5.9:_
_Tolerance of the USART receiver to clock deviation\*\*)._
