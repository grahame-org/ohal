...
Figure 350 shows an example of communication with RTS flow control enabled.
...
An interrupt is generated if the CTSIE bit in the USART_CR3 register is set. Figure 351
