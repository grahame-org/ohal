...
- Configure the AES mode, by programming the MODE[1:0] bitfield of the AES_CR
  ...
  - For decryption, select Mode 3 (MODE[1:0] = 10), unless ECB or CBC chaining
    ...
    encryption key, as described in *Section 22.4.5: AES decryption round key*
    *preparation*.
...
For ECB or CBC mode, refer to *Section 22.4.6: AES ciphertext stealing and data padding*.
