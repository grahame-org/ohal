...
- Configure the AES mode, by programming the MODE[1:0] bitfield of the AES_CR
  register.
    ...
    - For decryption, select Mode 3 (MODE[1:0] = 10), unless ECB or CBC chaining
      ...
      encryption key, as described in _Section 22.4.5: AES decryption round key preparation_.
...
_Note: Up to three wait cycles are automatically inserted between two consecutive writes to the AES_DINR register, to allow sending the key to the AES processor._
