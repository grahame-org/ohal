...
TAMPTS is valid even if TSE = 0 in the RTC*CR register. Timestamp flag is set up to 3
ck_apre cycles after the tamper flags.
\_Note:* \_TAMPTS must be cleared before entering RTC initialization mode.\_
