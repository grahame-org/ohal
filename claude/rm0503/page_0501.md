...
_Note: CECS bit is valid only if the CED bit in the RNG_CR register is set to 0._
...
_Note: The DRDY bit can rise when the peripheral is disabled (RNGEN = 0 in the RNG_CR register)._
