...
TIM1/15, with the SRAM_PARITY_LOCK control bit in the *SYSCFG configuration register 2*
*(SYSCFG_CFGR2)*. The SRAM Parity Error flag (SRAM_PEF) is available in the *SYSCFG*
*configuration register 2 (SYSCFG_CFGR2)*.

*Note:*
*When enabling the SRAM parity check, it is advised to initialize by software the whole*
...
the NRST (external reset) in *Section 5.1.2: System reset* for further details about how PF2-
