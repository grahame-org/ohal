...
_(SYSCFG_CFGR2)_. The SRAM Parity Error flag (SRAM*PEF) is available in the \_SYSCFG*
_configuration register 2 (SYSCFG_CFGR2)_.

_Note:_
_When enabling the SRAM parity check, it is advised to initialize by software the whole_
