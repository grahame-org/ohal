...
option byte (refer to _Section 3.4: FLASH option bytes_).
...
interrupts generated. The same error can also be linked to the BRK_IN Break input of
TIM1/15, with the SRAM_PARITY_LOCK control bit in the _SYSCFG configuration register 2_
