...
_Note:_
_As the BKBID, BKDSRM, BKF[3:0], AOE, BKP, BKE, OSSI, OSSR and DTG[7:0] bits may_
_be write-locked depending on the LOCK configuration, it may be necessary to configure all_
_of them during the first write access to the TIMx_BDTR register._
