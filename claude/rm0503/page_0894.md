...
operation is completed in the VDD voltage domain. Refer to *Table 162: IWDG delays versus*
...
domain. Refer to *Table 162: IWDG delays versus actions* for delay values.
