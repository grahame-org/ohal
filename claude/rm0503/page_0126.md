...
corresponding bit in the _AHB peripheral reset register (RCC_AHBRSTR)_, _APB peripheral reset register 1 (RCC_APBRSTR1)_, and _APB peripheral reset register 2_
\*(RCC*APBRSTR2)*.
