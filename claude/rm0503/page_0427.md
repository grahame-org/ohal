...
| ----------- | --- | --------------------------- | ----------------------------------------------------------------------------------- |
| OPAMP1_VINM | PA1 | OPAMP1_OUTor_PGA            | controlled_by_bits_OPAMODEand_VM_SEL.                                               |
| OPAMP1_VINP | PA0 | DAC1_OUT1                   | controlled_by_bit_VP_SEL.                                                           |
| OPAMP1_VOUT | PA3 | ADC1_IN8\_(throughthe_GPIO) | The pin is connected when the OPAMP is enabled. The ADC input is controlled by ADC. |
