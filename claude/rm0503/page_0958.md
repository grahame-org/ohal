...
1. The effects of tamper detection in confirmed mode is described with tamp*confirmed signal in \_Table 181: TAMP*
   _interconnection_.
2. The effects of tamper detection in potential mode is described with tamp*potential signal in \_Table 181: TAMP*
   _interconnection_.
