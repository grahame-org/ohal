...
\_To validate the protection level change, the option bytes must be reloaded by setting the OBL_LAUNCH bit of the \_\_FLASH control register (FLASH_CR)\*_._
