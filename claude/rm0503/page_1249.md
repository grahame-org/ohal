...
The debug state depends on the flash memory readout protection state (see *Section 3.5.1:*
...
1. Packet request (8 bits) transmitted by the host (see *Table 242*).
2. Acknowledge response (3 bits) transmitted by the target (see *Table 243*).
