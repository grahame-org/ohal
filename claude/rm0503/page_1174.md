...
description of OVR flag at \_Section 36.4.10: SPI status flags\*). An overrun event can be
...
both software and hardware (see \_Section 36.4.5: Slave select (NSS) pin management\*).
