...
*Note: The data specified in \_*Table 204\* and _Table 205 \*\*may slightly differ in the special case when the received frames contain some Idle frames of exactly 10-bit times when M bits = 00 (11- bit times when M= 01 or 9- bit times when M = 10)._
