...
_Note: If OCx is selected on TIM_3_as the trigger output (MMS=1xx), its rising edge is used to clock the counter of TIM_2_.\*
...
_Note: The counter_2_clock is not synchronized with counter 1, this mode only affects the TIM_2
