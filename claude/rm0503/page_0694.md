...
_Note:_
*If OCx is selected on TIM *3 _as the trigger output (MMS=1xx), its rising edge is used to clock_
*the counter of TIM *2*.*
...
_Note:_
*The counter *2 *clock is not synchronized with counter 1, this mode only affects the TIM *2
