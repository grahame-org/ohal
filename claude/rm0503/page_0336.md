...
1. Refer to \_Section Reset and clock control (RCC\*) for how the PCLK clock and ADC asynchronous clock are
   enabled.

The input clock of the analog ADC can be selected between two different clock sources (see
_Figure 35: ADC clock scheme_ to see how the PCLK clock and the ADC asynchronous clock
are enabled):
