...
Standby circuitry (see *Figure 6*). SRAM2 content can be preserved if the bit RRS is set in
...
mode. All registers are reset after wake-up from Standby except for *Power control register 3*
*(PWR_CR3)*.
