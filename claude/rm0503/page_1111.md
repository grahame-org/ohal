...
| ------------------- | ------------ | --------------------------- |
| lpuart it \_        | Output       | LPUART global interrupt     |
| lpuart tx dma \_ \_ | Input/output | LPUART transmit DMA request |
| lpuart rx dma \_ \_ | Input/output | LPUART receive DMA request  |
...
M1: bit 28) in the LPUART_CR1 register (see _Figure 328_).
