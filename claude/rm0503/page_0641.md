...
TIMx*CCER register).
See OC/OCN enable description for more details (\_Section 23.4.11: TIM1 capture/compare*
...
in the timer.
See OC/OCN enable description for more details (_Section 23.4.11: TIM1 capture/compare_
_enable register (TIM1_CCER)_).
...
_Note:_ _This bit can not be modified as soon as the LOCK level 2 has been programmed (LOCK_
