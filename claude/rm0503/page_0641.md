...
TIMx_CCER register).
See OC/OCN enable description for more details (Section 23.4.11: TIM1 capture/compare
...
and BRK sources, as per Figure 164: Break and Break2 circuitry overview).
