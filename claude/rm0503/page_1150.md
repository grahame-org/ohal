...
sets the flag TXFE (TXFIFO empty, bit 23 in the LPUART*ISR register).
...
\_Note:_ \_If the application needs to send the break character following all previously inserted data, including the ones not yet transmitted, the software must wait for the TXE flag assertion before setting the SBKRQ bit._
