...
_Note:* \_Setting ADDIS to ‘1’ is only effective when ADEN* = \*1 and ADSTART_ = \*0 (which ensures that no conversion is ongoing)\_
...
_Note:* \_The software is allowed to set ADEN only when ADCAL* = \*0, ADSTP_ = *0, ADSTART\_ = *0,\*
*ADDIS\_ = *0, ADEN* = *0, and ADVREGEN = 1.\*
...
Others: Reserved
\_Note:_ \_The channel selected by the AWDCH[4:0] bits must be also set into the CHSELR register._
