...
_Note:_ _Setting ADDIS to ‘1’ is only effective when ADEN_ = _1 and ADSTART_ = _0 (which ensures that no_
...
_Note:_ _The software is allowed to set ADEN only when ADCAL_ = _0, ADSTP_ = _0, ADSTART_ = _0,_
...
Others: Reserved
_Note:_ _The channel selected by the AWDCH[4:0] bits must be also set into the CHSELR_
_register._
