...
_Note: NIST does not approve this CBC-MAC as an authentication mode outside the context of the CCM specification._

CCM chaining is specified in NIST*Special Publication 800-38C, Recommendation for Block Cipher Modes of Operation - The CCM Mode for Authentication and Confidentiality*. A typical
message construction for CCM is given in _Figure 116_.
...
| B0  | [a]32 [a]16 | Associated data (A) | 0   |     | Plaintext (P)                            |     |     |     |     | 0   | Enc (T) |
| --- | ----------- | ------------------- | --- | --- | ---------------------------------------- | --- | --- | --- | --- | --- | ------- |
|     |             |                     |     |     |                                          |     |     |     |     |     |         |
|     |             |                     |     |     |                                          |     |     |     |     |     |         |
