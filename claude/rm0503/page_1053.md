...
_Note: The error checking code (LRC/CRC) must be computed/verified by software._
...
_Note: When logical data values are inverted (0 = H, 1 = L), the parity bit is also inverted in the same way._
