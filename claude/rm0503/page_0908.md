...
| ------------ | ----------------------------------------------------------------------------- |
| rtc_its      | From power controller (PWR): main power loss/switch to V detection BAT output |
| rtc_tamp_evt | From \_TAMP_peripheral:\_tamp_evt                                             |
| rtc_calovf   | To_TAMP_peripheral:\_tamp_itamp5                                              |
