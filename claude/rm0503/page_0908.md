...
| ------------------ | ----------------------------------------------------------------------------- |
| rtc its \_         | From power controller (PWR): main power loss/switch to V detection BAT output |
| rtc tamp evt \_ \_ | From TAMP peripheral: tamp evt \_                                             |
| rtc calovf \_      | To TAMP peripheral: tamp itamp5 \_                                            |
...
RTC_OUT1, RTC_TS and TAMP_IN1 are mapped on the same pin. The RTC and TAMP
functions mapped on this pin are available in all power modes. This pin output mechanism
follows the priority order shown in _Table 173_.
