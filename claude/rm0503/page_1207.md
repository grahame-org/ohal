...
endpoint, the USB peripheral accesses the contents of CHEP*TXBD_n (fields ADDRn_TX
...
be transmitted (refer to \_Structure and usage of packet buffers on page 1204*) and the USB
