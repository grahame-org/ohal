...
FPD_LPRUN, FPD_LPSLP or FPD_STOP bits, and enter the corresponding low-power
mode.
0: Flash memory in power down
1: Flash memory ready to be accessed

_Note: If the system boots from SRAM, the user application must wait until the FLASH_RDY bit is set, prior to jumping to flash memory._
...
| Res. | Res. | Res. | Res. | Res. | Res. | Res. | CSBF | Res. | CWUF7 | Res. | CWUF5 | CWUF4 | CWUF3 | CWUF2 | CWUF1 |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ----- | ---- | ----- | ----- | ----- | ----- | ----- |
|      |      |      |      |      |      |      | w    |      | w     |      | w     | w     | w     | w     | w     |
