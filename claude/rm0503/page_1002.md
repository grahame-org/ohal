...
1. Refer to *Section 33.3: I2C implementation* for information about the Stop modes supported by each
...
|  | Transfer complete reload | TCR | TCIE | Write I2C CR2 with NBYTES_ [7:0] ≠ 0 |  |  |  |
