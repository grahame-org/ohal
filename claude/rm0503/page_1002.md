...
| ----------------- | -------------------------------- | ---------- | ------------------ | ------------------------------------- | --------------- | --------------- | ------------------ |
| I2C EV \_         | Receive buffer not empty         | RXNE       | RXIE               | Read I2C RXDR \_ register             | Yes             | No              | No                 |
|                   | Transmit buffer interrupt status | TXIS       | TXIE               | Write I2C TXDR \_ register            |                 |                 |                    |
...
| I2C ERR \_        | Bus error                        | BERR       | ERRIE              | Write BERRCF = 1                      | Yes             | No              | No                 |
