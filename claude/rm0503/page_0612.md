...
_Note:_
_The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2_
...
_Note:_
_The clock of the ADC must be enabled prior to receive events from the master timer, and_
