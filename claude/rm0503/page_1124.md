...
_Note: If the MMRQ is set while the IDLE character has already elapsed, mute mode is not entered_
_(RWU is not set)._
...
_Note: In 7-bit and 9-bit data modes, address detection is done on 6-bit and 8-bit addresses_
