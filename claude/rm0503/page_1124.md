...
_Note:_
_When FIFO management is enabled, when MMRQ bit is set while the receiver is sampling_
_the last bit of a data, this data may be received before effectively entering in mute mode._
