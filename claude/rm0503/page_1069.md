...
\_Note:* _If the USART does not support smartcard mode, this bit is reserved and must be kept at_
...
\_Note:* _If the USART does not support the Receiver timeout feature, this bit is reserved and_
_must be kept at reset value.**Section 34.4: USART implementation**._
...
_Note:_ _If the Driver Enable feature is not supported, this bit is reserved and must be kept at_
_reset value. Refer to **Section 34.4: USART implementation**._
...
This bitfield can only be written when the USART is disabled (UE = 0).
\_Note:* _If the Driver Enable feature is not supported, this bit is reserved and must be kept at_
_reset value. Refer to **Section 34.4: USART implementation**._
