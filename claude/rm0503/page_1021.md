...
| ------------ | ------------ | ---------------------------------- |
| usart pclk   | Input        | APB clock                          |
| usart ker ck | Input        | USART kernel clock                 |
| usart wkup   | Output       | USART provides a wake-up interrupt |
| usart it     | Output       | USART global interrupt             |
| usart tx dma | Input/output | USART transmit DMA request         |
| usart rx dma | Input/output | USART receive DMA request          |
...
bit 28) in the USART*CR1 register (see \_Figure 328*):
