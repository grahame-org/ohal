...
_Note:_
_The closer the trimming value is to the optimum trimming value, the longer it takes to_
_stabilize. The maximum stabilization time remains below 1 ms in any case._
