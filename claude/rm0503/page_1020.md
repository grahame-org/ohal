...
| ------------------------- | ----------- | ------------------------------------------------------- |
| USART RX/UART RX          | Input       | Serial data receive input                               |
| USART TX/UART TX          | Output      | Transmit data output                                    |
| USART CTS/UART CTS        | Input       | Clear to send                                           |
| USART RTS/UART RTS        | Output      | Request to send                                         |
| USART DE(1)/UART DE(2) \_ | Output      | Driver enable                                           |
| USART CK                  | Output      | Clock output in synchronous master and smartcard modes. |
