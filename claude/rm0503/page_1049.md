...
_Note:_
_An underrun error may occur if the moment the data is written to the USART_TDR is too_
_close to the first CK transmission edge. To avoid this underrun error, the USART_TDR must_
*be written 3 *usart_ker_ck _cycles before the first CK edge._
