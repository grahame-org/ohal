...
_Note:_
_The AES is disabled by hardware when the derivation key is available._

_To restart a derivation key computation, repeat steps **4**,**5**,**6**, and **7**._

_Note:_
_The operation of the key preparation lasts 59 or 82 clock cycles, depending on the key size_
_(128- or 256-bit)._
...
_Note:_
_Ciphertext stealing techniques are not documented in this reference manual._
...
_Note:_
_Padding data are swapped in a similar way as normal data, according to the_
_DATATYPE[1:0] field of the AES_CR register (see \*\*Section 22.4.13: AES data registers and_
_data swapping \*\*for details)._
