...
in Section 22.4.4: AES procedure to perform a cipher operation on page 511 to manage
...
DATATYPE[1:0] field of the AES_CR register (see Section 22.4.13: AES data registers and
