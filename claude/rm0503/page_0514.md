...
_To restart a derivation key computation, repeat steps 4 , 5 , 6 , and 7._

_Note: The operation of the key preparation lasts 59 or 82 clock cycles, depending on the key size (128- or 256-bit)._
...
described in NIST _Special Publication 800-38A, Recommendation for Block Cipher Modes of Operation: Three Variants of Ciphertext Stealing for CBC Mode_. Since the AES peripheral
...
_Note: Padding data are swapped in a similar way as normal data, according to the DATATYPE[1:0] field of the AES_CR register (see Section 22.4.13: AES data registers and data swapping for details)._
