...
reference and VREF+ can be replaced by the expression provided in *Calculating the actual*
*V **REF+**voltage using the internal reference voltage*, resulting in the following formula:
