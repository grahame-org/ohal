...
_Figure 287_ gives an example where the LPTIM channel 1 is configured in PWM mode with
...
_Figure 288_ shows some edge-aligned PWM waveforms in an example where
LPTIM_ARR = 8.
