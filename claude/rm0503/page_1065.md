...
the USART receiver tolerance (see _Section 34.5.9: Tolerance of the USART receiver to clock deviation_).

Let us take the example of OVER8 = 0, M bits = 01, ONEBIT = 0 and BRR [3:0] = 0000.

In these conditions, according to _Table 204: Tolerance of the USART receiver when BRR_ \*[3:0] = 0000\_, the USART receiver tolerance equals 3.41%.
...
1. Refer to _Section 34.4: USART implementation_ to know if the wake-up from Stop mode is supported for a
...
Refer to _Table 208_ for a detailed description of all USART interrupt requests.
