...
the USART receiver tolerance (see _Section 34.5.9: Tolerance of the USART receiver to_
_clock deviation_).

Let us take the example of OVER8 = 0, M bits = 01, ONEBIT = 0 and BRR [3:0] = 0000.

In these conditions, according to _Table 204: Tolerance of the USART receiver when BRR_
