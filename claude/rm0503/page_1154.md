...
_Note:_ _The IDLE bit is not set again until the RXFNE bit has been set (that is, a new idle line_
_occurs)._
...
1: Noise is detected
_Note:_ _This bit does not generate an interrupt as it appears at the same time as the RXFNE bit_
...
_Note:_ _This error is associated with the character in the LPUART_RDR._
