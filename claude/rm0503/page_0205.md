...
The register bits are only reset upon RTC domain reset (see _Section 5.1.3: RTC domain reset_), except the LSCOSEL, LSCOEN, and BDRST bits that are only reset upon RTC
