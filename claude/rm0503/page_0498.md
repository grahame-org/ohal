...
3. The noise source sampling must be 48 MHz or less. Hence, if the RNG clock is different from 48 MHz, this value of CLKDIV
   must be adapted. See the CLKDIV bitfield description in _Section 21.7.1_ for details.
...
### “_STM32 microcontrollers random number generation validation using NIST statistical test_

### _suite_” available from _www.st.com_.
