...
As shown in Figure 25, upon the detected edge of the synchronization input, the pending
...
Note:
The NBREQ field value can be written by software only when both synchronization enable
