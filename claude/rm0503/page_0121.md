...
The Low-power sleep mode is entered from Low-power run mode according _Section : Entering low-power mode_, when the SLEEPDEEP bit in the Cortex®-M0+ System Control
register is clear.
