...
*When the bus clock is much faster than the analog ADC clock (f **ADC**), a minimum delay of*
*ten f **ADC **clock cycles must be respected between ADEN and ADDIS bit settings.*
