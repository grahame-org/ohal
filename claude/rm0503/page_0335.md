...
*When the bus clock is much faster than the analog ADC clock (f \_*ADC**), a minimum delay of ten f **ADC \*_clock cycles must be respected between ADEN and ADDIS bit settings._
