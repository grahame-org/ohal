...
_Note: 1. This bit should not be changed when communication is ongoing. 2. This bit is not used in SPI TI mode._
...
_Note: When disabling the SPI, follow the procedure described in Procedure for disabling the SPI on page 1174._
