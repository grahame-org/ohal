...
_Note:_
Similar behavior is encountered when CPOL = 0. In this case the sampling edge is the _rising_
...
pin state changes to HiZ when the current transaction finishes (see _Figure 383_). Any baud
