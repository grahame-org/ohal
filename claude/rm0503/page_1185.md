...
*Figure 382* illustrates NSS pin management when NSSP pulse mode is enabled.
...
pin state changes to HiZ when the current transaction finishes (see *Figure 383*). Any baud
