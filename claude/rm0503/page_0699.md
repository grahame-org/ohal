...
\_Note:* _It is not allowed to switch from edge-aligned mode to center-aligned mode as long as_
...
_Note:_ _This bit is read only when the timer is configured in Center-aligned mode or Encoder_
_mode._
