...
The block diagram of the touch sensing controller is shown in _Figure 85_.
...
up to four GPIOs (see _Figure 86_). Several analog I/O groups are available to allow the
