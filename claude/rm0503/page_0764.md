...
DTG bits in the TIMx_BDTR register. Refer to _Section 26.6.14: TIM16 break and dead-time_
_register (TIM16_BDTR) on page 819_ for delay calculation.
...
_Note:_
_When only OCxN is enabled (CCxE=0, CCxNE=1), it is not complemented and becomes_
