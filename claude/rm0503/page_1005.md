...
*Note:\* _If the analog filter is enabled, the digital filter is added to it. This filter can be_
...
_Note:_ _Any of these errors generates an interrupt:_
...
_Note:_ _Any of these events generates an interrupt:_
