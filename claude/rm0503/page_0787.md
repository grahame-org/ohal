...
- When CNT is reinitialized by a trigger event (refer to _Section 26.5.3: TIM15 slave mode control register (TIM15_SMCR)_), if URS=0 and UDIS=0 in the TIMx_CR1 register.
