...
*Note:*
*t **AF(min)**and t **AF(max)**are only part of the condition when the analog filter is enabled. Refer to*
*the device datasheet for t **AF **values.*
...
*stretches SCL low during at least**[(SDADEL + SCLDEL + 1) x (PRESC + 1) + 1] x t **I2CCLK**, in both*
