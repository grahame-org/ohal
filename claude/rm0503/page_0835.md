...
_Note:_
_The timer must be enabled before setting the SNGSTRT/CNTSTRT bits. Any write on these_
_bits when the timer is disabled is discarded by hardware._

_Note:_
_When starting the counter by software (TRIGEN[1:0] = 00), there is a delay of 3 kernel clock_
