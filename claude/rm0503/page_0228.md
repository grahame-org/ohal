...
Note: The Cortex-M0+ output EVENTOUT signal can be output as alternate function on
several I/Os. An event can be signaled through the configured pin after executing
SEV instruction.
