...
\_Note:_ \_If the USART does not support the auto baud rate feature, this bit is reserved and kept at reset value._
...
0: No underrun error
1: underrun error
\_Note:_ \_If the USART does not support the SPI slave mode, this bit is reserved and kept at reset value. Refer to **Section 34.4: USART implementation**._
...
_Section 34.4: USART implementation\__.\*
