...
the ABRRQ in the USART*RQR register.
\_Note:* \_If the USART does not support the auto baud rate feature, this bit is reserved and kept at reset value.\_
...
It is cleared by software, by writing 1 to the ABRRQ bit in the USART*RQR register.
\_Note:* \_If the USART does not support the auto baud rate feature, this bit is reserved and kept at reset value.\_
...
appears while the software has not yet loaded any value into USART*TDR. This flag is
reset by setting UDRCF bit in the USART_ICR register.
0: No underrun error
1: underrun error
\_Note:* \_If the USART does not support the SPI slave mode, this bit is reserved and kept at reset value. Refer to **Section 34.4: USART implementation**.\_
...
An interrupt is generated if EOBIE = 1 in the USART*CR1 register.
It is cleared by software, writing 1 to EOBCF in the USART_ICR register.
0: End of block not reached
1: End of block (number of characters) reached
\_Note:* \_If smartcard mode is not supported, this bit is reserved and kept at reset value. Refer to\_

\_Section 34.4: USART implementation\_\_.\*
