...
\_Note:* _If the USART does not support the auto baud rate feature, this bit is reserved and kept_
_at reset value._
...
0: No underrun error
1: underrun error
\_Note:* _If the USART does not support the SPI slave mode, this bit is reserved and kept at_
...
\_Note:* _If smartcard mode is not supported, this bit is reserved and kept at reset value. Refer to_
...
\_Note:* _If a time equal to the value programmed in RTOR register separates 2 characters,_
