...
For more details, refer to _Section 14.6.5: Managing converted data using the DMA on_
_page 351_.
...
conversion.
_Note:_ _The software is allowed to write these bits only when the ADC is disabled (ADCAL_ = _0,_
