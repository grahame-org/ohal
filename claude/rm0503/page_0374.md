...
For more details, refer to _Section 14.6.5: Managing converted data using the DMA on page 351_.
...
refer to _Section 14.6.5: Managing converted data using the DMA on page 351_.
0: DMA disabled
1: DMA enabled
...
conversion.
_Note:* \_The software is allowed to write these bits only when the ADC is disabled (ADCAL* = *0,*
