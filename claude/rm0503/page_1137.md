...
_Note:_ _In 7-bit data length mode, the smartcard mode, LIN master mode and auto baud rate_
...
lpuart*ker_ck clock cycles. For more details, refer \_Section 35.4.14: RS232 hardware flow*
_control and RS485 driver enable_.
