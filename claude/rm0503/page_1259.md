...
1. Program the transaction target address in the _APx transfer address register (APx_TAR) (x = 0, 1)_.
...
3. Write to or read from the _APx data read/write register (APx_DRW) (x = 0, 1)_ to initiate a
   bus transaction at the address held in AP*TAR. Alternatively, a read or write to the \_APx banked data n register (APx_BDn) (x = 0, 1)* triggers access to the TAR[31:4] + n
