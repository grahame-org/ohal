...
2. The A(3:2) and RnW fields are part of the packet request word sent to the SW-DP with
   the APnDP bit set (see \_Table 242\*). Program the A(3:2) field with the register address
...
3. Write to or read from the _APx data read/write register (APx_DRW) (x = 0, 1)_ to initiate a
   bus transaction at the address held in AP_TAR. Alternatively, a read or write to the _APx banked data n register (APx_BDn) (x = 0, 1)_ triggers access to the TAR[31:4] + n
