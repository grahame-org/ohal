...
DBG_STANDBY and/or DBG_STOP bits in the *DBGMCU configuration register*
*(DBGMCU_CR)*. These bits, when set, maintain the clock and power to the processor while
