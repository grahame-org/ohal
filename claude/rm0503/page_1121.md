...
_Note:_
_The baud counters are updated to the new value in the baud registers after a write operation_
_to LPUART_BRR. Hence, the baud rate register value must not be changed during_
_communication._
