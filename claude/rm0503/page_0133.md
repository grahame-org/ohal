...
011: Standby mode
1xx: Shutdown mode
_Note:_ _If LPR bit is set, Stop 2 mode cannot be selected and Stop 1 mode shall be entered_
_instead of Stop 2._
_In Standby mode, SRAM2 can be preserved or not, depending on RRS bit configuration_
_in PWR_CR3._
