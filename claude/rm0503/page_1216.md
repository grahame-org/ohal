...
| -------------- | -------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Transmit (OUT) | 0              | USB_CHEP_TXRXBD_0(ADDRn_TX / COUNTn_TX)Buffer_description_table_locations. | USB_CHEP_RXTXBD_0(ADDRn_TX / COUNTn_TX)Buffer_description_table_locations  |
|                | 1              | USB_CHEP_RXTXBD_0(ADDRn_TX / COUNTn_TX)Buffer_description_table_locations  | USB_CHEP_TXRXBD_0(ADDRn_TX / COUNTn_TX)Buffer_description_table_locations. |
| Receive (IN)   | 0              | USB_CHEP_RXTXBD_0(ADDRn_RX / COUNTn_RX)Buffer_description_table_locations. | USB_CHEP_TXRXBD_0(ADDRn_RX / COUNTn_RX)Buffer_description_table_locations. |
|                | 1              | USB_CHEP_TXRXBD_0(ADDRn_RX / COUNTn_RX)Buffer_description_table_locations  | USB_CHEP_RXTXBD_0(ADDRn_RX / COUNTn_RX)Buffer_description_table_locations. |
