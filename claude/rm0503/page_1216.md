...
| -------------- | -------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Transmit (OUT) | 0              | USB CHEP TXRXBD 0 \_ \_ _ (ADDRn TX / COUNTn TX) _ \_ Buffer description table locations. | USB CHEP RXTXBD 0 \_ \_ _ (ADDRn TX / COUNTn TX) _ \_ Buffer description table locations  |
|                | 1              | USB CHEP RXTXBD 0 \_ \_ _ (ADDRn TX / COUNTn TX) _ \_ Buffer description table locations  | USB CHEP TXRXBD 0 \_ \_ _ (ADDRn TX / COUNTn TX) _ \_ Buffer description table locations. |
| Receive (IN)   | 0              | USB CHEP RXTXBD 0 \_ \_ _ (ADDRn RX / COUNTn RX) _ \_ Buffer description table locations. | USB CHEP TXRXBD 0 \_ \_ _ (ADDRn RX / COUNTn RX) _ \_ Buffer description table locations. |
|                | 1              | USB CHEP TXRXBD 0 \_ \_ _ (ADDRn RX / COUNTn RX) _ \_ Buffer description table locations  | USB CHEP RXTXBD 0 \_ \_ _ (ADDRn RX / COUNTn RX) _ \_ Buffer description table locations. |
