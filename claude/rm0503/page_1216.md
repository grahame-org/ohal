...
| -------------- | -------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Transmit (OUT) | 0              | USB CHEP TXRXBD 0 \* \_ \* (ADDRn TX / COUNTn TX) \* \_ Buffer description table locations. | USB CHEP RXTXBD 0 \* \* \_ (ADDRn TX / COUNTn TX) \* \_ Buffer description table locations  |
|                | 1              | USB CHEP RXTXBD 0 \* \_ \* (ADDRn TX / COUNTn TX) \* \_ Buffer description table locations  | USB CHEP TXRXBD 0 \* \* \_ (ADDRn TX / COUNTn TX) \* \_ Buffer description table locations. |
| Receive (IN)   | 0              | USB CHEP RXTXBD 0 \* \_ \* (ADDRn RX / COUNTn RX) \* \_ Buffer description table locations. | USB CHEP TXRXBD 0 \* \* \_ (ADDRn RX / COUNTn RX) \* \_ Buffer description table locations. |
|                | 1              | USB CHEP TXRXBD 0 \* \_ \* (ADDRn RX / COUNTn RX) \* \_ Buffer description table locations  | USB CHEP RXTXBD 0 \* \* \_ (ADDRn RX / COUNTn RX) \* \_ Buffer description table locations. |
