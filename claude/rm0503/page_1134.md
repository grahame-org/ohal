...
receiver tolerance (see *Section 35.4.9: Tolerance of the LPUART receiver to clock*
*deviation*).

Let us take the example of OVER8 = 0, M bits = 01, ONEBIT = 0 and BRR [3:0] = 0000.

In these conditions, according to *Table 215: Tolerance of the LPUART receiver*, the
...
1. Refer to *Section 35.3: LPUART implementation* to know if the wake-up from Stop mode is supported for a
