...
_Note: When the LCD relies on the internal stepup converter, the VLCD pin must be connected to V \_\_SS **with a capacitor. Its typical value is 1 μF (see C **EXT \*\*value in the datasheet for details)._
