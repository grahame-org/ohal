...
due to the unknown status of the prescaler when writing to the WWDG*CR register (see
\_Figure 299*). The _WWDG configuration register (WWDG_CFR)_ contains the high limit of the
...
_Note: The T6 bit can be used to generate a software reset (the WDGA bit is set and the T6 bit is cleared)._
