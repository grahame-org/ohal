...
_Note: This bit should not be changed when communication is ongoing. This bit is not used in SPI TI mode except the case when CRC is applied at TI mode._
...
_Note: Refer to Procedure for disabling the SPI on page 1174 if the CRCEN bit is set._
