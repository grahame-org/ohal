...
Others: Reserved
See _Table 135: TIMx internal trigger connection on page 705_ for more details on ITRx
meaning for each Timer.
_Note:_ _These bits must be changed only when they are not used (e.g. when SMS=000) to_
