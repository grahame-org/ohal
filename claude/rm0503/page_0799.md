...
\_Note:* _This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in_
...
TIMx*CCER register)
See OC/OCN enable description for more details (\_Section 26.5.9: TIM15 capture/compare*
