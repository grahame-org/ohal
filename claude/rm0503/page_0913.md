...
- and from around 18 h to 36 h when WUCKSEL[2:1] = 11. In this last case 216 is
  ...
  complete (see _Programming the wake-up timer on page 915_), the timer starts
...
The wake-up flag is output on an internal signal rtc*wut that can be used by other
