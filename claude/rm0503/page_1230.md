...
Each endpoint/channel has its USB*CHEPnR register where \_n* is the endpoint/channel
identifier.
...
| Res. | THREE ERR \_ \_ RX[1:0] |          | THREE ERR \_ \_ TX[1:0] |          | ERR \_ RX | ERR \_ TX | LS EP \_ | NAK      | DEVADDR[6:0] |     |     |     |     |     |     |
| ---- | ----------------------- | -------- | ----------------------- | -------- | --------- | --------- | -------- | -------- | ------------ | --- | --- | --- | --- | --- | --- |
|      | rc w0 \_                | rc w0 \_ | rc w0 \_                | rc w0 \_ | rc w0 \_  | rc w0 \_  | rw       | rc w0 \_ | rw           | rw  | rw  | rw  | rw  | rw  | rw  |

| VTRX     | DTOG RX | STATRX[1:0] |     | SETUP | UTYPE[1:0] |     | EP KIND | VTTX     | DTOG TX | STATTX[1:0] |     | EA[3:0] |     |     |     |
| -------- | ------- | ----------- | --- | ----- | ---------- | --- | ------- | -------- | ------- | ----------- | --- | ------- | --- | --- | --- |
| rc w0 \_ | t       | t           | t   | r     | rw         | rw  | rw      | rc w0 \_ | t       | t           | t   | rw      | rw  | rw  | rw  |
