...
Figure 229 shows the behavior with the same configuration as in Figure 228 but in trigger
...
with the enable of TIM3. Refer to Figure 224 for connections. To ensure the counters are
