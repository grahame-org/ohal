...
| -------------- | ---- | ------ | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Transmit (OUT) | 0    | 1      | USB CHEP TXRXBD 0 _ \_ _ (ADDR TX / COUNT TX) \* \_ Buffer description table locations. | USB CHEP RXTXBD 0 \* _ \_ (ADDR TX / COUNT TX) _ \_ Buffer description table locations  |
...
| Receive (IN)   | 0    | 1      | USB CHEP RXTXBD 0 _ \_ _ (ADDR RX / COUNT RX) \* \_ Buffer description table locations. | USB CHEP TXRXBD 0 \* _ \_ (ADDR RX / COUNT RX) _ \_ Buffer description table locations. |
