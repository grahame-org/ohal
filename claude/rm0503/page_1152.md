...
_Note:_ _When UESM is cleared, WUF flag is also cleared._
...
_Note:_ _If the LPUART does not support the wake-up from Stop feature, this bit is reserved and_
