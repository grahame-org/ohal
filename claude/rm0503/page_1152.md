...
\_Note:* _When UESM is cleared, WUF flag is also cleared._
*If the *LPUART _does not support the wake-up from Stop feature, this bit is reserved and_
_kept at reset value. Refer to **Section 35.3: LPUART implementation**._
...
\_Note:* _If the LPUART does not support the wake-up from Stop feature, this bit is reserved and_
