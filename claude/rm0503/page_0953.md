...
_Note:_
_Tamper detection is still active when V **DD **power is switched off. To avoid unwanted resetting_
_of the backup registers, the pin to which the TAMPx is mapped should be externally tied to_
_the correct level._
