...
motor and another timer TIMx (TIM2, TIM3) referred to as “interfacing timer” in *Figure 176*.
...
capture signal is TRC (See *Figure 149: Capture/compare channel (example: channel 1*
*input stage) on page 576*). The captured value, which corresponds to the time elapsed
