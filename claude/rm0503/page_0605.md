...
capture signal is TRC (See _Figure 149: Capture/compare channel (example: channel 1_
_input stage) on page 576_). The captured value, which corresponds to the time elapsed
