...
_Note:_ _Warning: MSIRANGE can be modified when MSI is OFF (MSION=0) or when MSI is_
_ready (MSIRDY=1). MSIRANGE must NOT be modified when MSI is ON and NOT_
_ready (MSION=1 and MSIRDY=0)_
...
_Note:_ _Once the MSION bit is cleared, MSIRDY goes low after 6 MSI clock cycles._
