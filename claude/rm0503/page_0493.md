...
_Note:_
_When data is not ready (DRDY = 0) RNG_DR returns zero._
_It is recommended to always verify that RNG_DR is different from zero. Because when it is_
_the case a seed error occurred between RNG_SR polling and RND_DR output reading (rare_
_event)._
