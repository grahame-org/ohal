...
the RTS output. *Figure 363* shows how to connect two devices in this mode.
...
frame. *Figure 364* shows an example of communication with RTS flow control enabled.
