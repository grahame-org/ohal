...
The HSI16 RC can be switched on and off using the HSION bit in the _Clock control register (RCC_CR)_.
...
adjusted by software by using the MSIRANGE[3:0] bits in the _Clock control register (RCC_CR)_. Twelve frequency ranges are available: 100 kHz, 200 kHz, 400 kHz, 800 kHz,
