...
_Note:_
_A detected configurable event interrupt pending request can be cleared by the CPU. The_
...
selection of GPIO port as EXTI mux output is controlled through the _EXTI external interrupt_
_selection register x (EXTI_EXTICRx)_ register.
