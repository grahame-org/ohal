...
_Note:_ _This bit cannot be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note:_ _Any write operation to this bit takes a delay of 1 APB clock cycle to become effective._
...
_Note:* \_The BRK2 must only be used with OSSR = OSSI = 1. Note:* *This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note:* \_Any write operation to this bit takes a delay of 1 APB clock cycle to become effective._
