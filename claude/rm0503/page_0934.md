...
_Note:_ _CALM[1:0] are stuck at 00 when CALW8 = 1. Refer to \*\*Section 31.3.14: RTC smooth_
...
_Note:_ _CALM[0] is stuck at 0 when CALW16 = 1. Refer to \*\*Section 31.3.14: RTC smooth digital_
_calibration\*\*._
