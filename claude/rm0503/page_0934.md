...
- 488.5 ppm). This feature is intended to be used in conjunction with CALM, which lowers the frequency of
  ...
  (512 × CALP) - CALM.
  Refer to _Section 31.3.14: RTC smooth digital calibration_.

#### Bit 14 CALW8: Use an 8-second calibration cycle period

When CALW8 is set to 1, the 8-second calibration cycle period is selected.
\_Note:_ \_CALM[1:0] are stuck at 00 when CALW8 = 1. Refer to \*\*Section 31.3.14: RTC smooth digital calibration\_\_._
...
\_Note:_ \_CALM[0] is stuck at 0 when CALW16 = 1. Refer to \*\*Section 31.3.14: RTC smooth digital calibration\_\_._
...
CALP. See _Section 31.3.14: RTC smooth digital calibration on page 918_.
