...
the RSF bit of RTC*ICSR register is set (see \_Section 31.6.10: RTC shift control register (RTC_SHIFTR)*). The copy is not performed in Stop and Standby mode. When exiting these
