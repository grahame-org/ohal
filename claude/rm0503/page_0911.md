...
prescaler (see _Section 31.3.8: Periodic auto-wake-up_ for details).
...
the RSF bit of RTC_ICSR register is set (see _Section 31.6.10: RTC shift control register_
