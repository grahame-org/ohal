...
_Note: This bit is available only on the STM32U0x3xx devices._
...
_Note: These bits are write-protected when the bit PVDL (PVD Lock) is set in the SYSCFG_CBR register. These bits are reset only by a system reset._
...
_Note: This bit is write-protected when the bit PVDL (PVD Lock) is set in the SYSCFG_CBR register. This bit is reset only by a system reset._
...
| EIWUL | Res. | Res. | Res. | Res. | APC | ENULP | RRS | Res. | EWUP7 | Res. | EWUP5 | EWUP4 | EWUP3 | EWUP2 | EWUP1 |
| ----- | ---- | ---- | ---- | ---- | --- | ----- | --- | ---- | ----- | ---- | ----- | ----- | ----- | ----- | ----- |
