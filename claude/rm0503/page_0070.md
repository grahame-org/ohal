...
_Note:_
_The HSI16 internal oscillator is automatically enabled when the STRT bit is set. It is_
_automatically disabled when the STRT bit is cleared, except if previously enabled with the_
_HSION bit of the RCC_CR register._
