...
_Table 130_. The counter is clocked by each valid transition on TI1FP1 or TI2FP2 (TI1 and TI2
...
_Note: The prescaler must be set to zero when encoder mode is enabled_
