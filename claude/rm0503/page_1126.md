...
_Note: Refer to \_\_Section 35.3: LPUART implementation \*\*to determine if the DMA mode is supported._
\_If DMA is not supported, use the LPUSRT as explained in **Section 35.4.7**. To perform continuous communication. When FIFO is disabled, clear the TXE/ RXNE flags in the LPUART_ISR register.\*
...
Section_direct memory access controller\*) to the LPUART_TDR register whenever the TXE
