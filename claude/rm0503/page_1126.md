...
Note:
Refer to Section 35.3: LPUART implementation to determine if the DMA mode is supported.
If DMA is not supported, use the LPUSRT as explained in Section 35.4.7. To perform
