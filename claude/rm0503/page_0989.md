...
*Note:*
*The SCLL[7:0] bitfield also determines the **t **BUF* *and **t **SU:STA **timings and SCLH[7:0] the*
*t **HD:STA* *and **t **SU:STO **timings**.*

Refer to *Section 33.4.10* for examples of I2C_TIMINGR settings versus the I2CCLK
frequency.
