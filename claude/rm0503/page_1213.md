...
The application software is responsible for DTOG and SW*BUF bits initialization according
...
SW_BUF having the same value, see \_Table 226*). The application software responds to the
...
Similar to the Device mode table, a new table below _Table 227: Bulk double-buffering memory buffers usage (Host mode)_ shows the programming settings for OUT and IN
tokens.
