...
SW_BUF having the same value, see *Table 226*). The application software responds to the
...
Similar to the Device mode table, a new table below *Table 227: Bulk double-buffering*
