...
*flash memory Base address + [WRP1x_STRT x 0x0800]* (included)

to the address

*flash memory Base address + [(WRP1x_END+1) x 0x0800]* (excluded).
...
*Note:*
*When the flash memory read protection level is selected (RDP level = 1), it is not possible to*
