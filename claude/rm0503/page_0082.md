...
base address. These offsets are defined in the WRP address registers _FLASH WRP area A address register (FLASH_WRP1AR)_ and _FLASH WRP area B address register_
\*(FLASH*WRP1BR)*.
