...
_Note:_
*TSEL *1*[3:0] bit cannot be changed when the EN *1 _bit is set._

*When software trigger is selected, the transfer from the DAC_DHR *1 _register to the_
*DAC_DOR *1 _register takes only one dac_pclk clock cycle._
