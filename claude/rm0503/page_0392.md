...
_Note: TSEL_1_[3:0] bit cannot be changed when the EN_1 _bit is set._

\_When software trigger is selected, the transfer from the DAC_DHR_1 \_register to the DAC_DOR_1 _register takes only one dac \_pclk clock cycle._
