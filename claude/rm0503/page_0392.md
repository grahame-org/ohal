...
nection table in *Section 15.4.2*.
...
*Note:*
*TSEL *1*[3:0] bit cannot be changed when the EN *1 *bit is set.*

*When software trigger is selected, the transfer from the DAC_DHR *1 *register to the*
*DAC_DOR *1 *register takes only one dac_pclk clock cycle.*
