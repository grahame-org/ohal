...
This bit is set and cleared by software to select right or left alignment. Refer to _Figure 44:_
_Data alignment and resolution (oversampling disabled: OVSE = 0) on page 349_
0: Right alignment
1: Left alignment
