...
These bits select the external event used to trigger the start of conversion (refer to *Table 68:*
...
This bit is set and cleared by software to select right or left alignment. Refer to *Figure 44:*
*Data alignment and resolution (oversampling disabled: OVSE = 0) on page 349*
0: Right alignment
1: Left alignment
...
*Note:* *If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register*
