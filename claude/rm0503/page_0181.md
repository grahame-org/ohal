...
to setting the HSION (refer to _Clock control register (RCC_CR)_). When HSION is not set
...
| Res. | Res. | Res. | Res. | Res. | HSI48RDYC | LSECSSC | CSSC | Res. | Res. | PLLRDYC | HSERDYC | HSIRDYC | MSIRDYC | LSERDYC | LSIRDYC |
| ---- | ---- | ---- | ---- | ---- | --------- | ------- | ---- | ---- | ---- | ------- | ------- | ------- | ------- | ------- | ------- |
|      |      |      |      |      | w         | w       | w    |      |      | w       | w       | w       | w       | w       | w       |
