...
_Figure 215_ shows the behavior of the OCxREF signal when the ETRF input becomes high,
...
_Note: In case of a PWM with a 100% duty cycle (if CCRx>ARR), OCxREF is enabled again at the next counter overflow._
