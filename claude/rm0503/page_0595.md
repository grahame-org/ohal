...
The BRK has a higher priority than BRK2 input, as described in _Table 128_.

_Note: BRK2 must only be used with OSSR = OSSI = 1._
...
_Figure 166_ gives an example of OCx and OCxN output behavior in case of active signals on
