...
It is used to monitor that either one selected channel or all enabled channels (see Table 73:
...
Table 73 shows how to configure the AWD1SGL and AWD1EN bits in the ADC_CFGR1
