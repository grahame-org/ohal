...
_Note:_
_If the actual value of the TRIM field is close to its limits and the automatic trimming can force_
...
_Note:_
_The trimming step size depends upon the product, check the datasheet for accurate setting._
