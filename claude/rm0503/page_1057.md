...
_Note:_
_Refer to **Section 34.4: USART implementation **to determine if the DMA mode is supported. If_
_DMA is not supported, use the USART as explained in **Section 34.5.7**. To perform_
_continuous communications when the FIFO is disabled, clear the TXE/ RXNE flags in the_
_USART_ISR register._
...
_Note:_
_The DMAT bit must not be cleared before the DMA end of transfer._
