...
*Note: Refer to \_*Section 34.4: USART implementation **to determine if the DMA mode is supported. If DMA is not supported, use the USART as explained in **Section 34.5.7\*\*. To perform continuous communications when the FIFO is disabled, clear the TXE/ RXNE flags in the USART*ISR register.*
