...
For more details, refer to the LCKR register description in _Section 7.4.8: GPIO port_
_configuration lock register (GPIOx_LCKR) (x = A to F)_.
...
_EXTI direct event input wake-up._
