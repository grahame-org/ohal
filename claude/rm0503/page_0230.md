...
The LOCK sequence (refer to _Section 7.4.8: GPIO port configuration lock register (GPIOx_LCKR) (x = A to F)_) can only be performed using a word (32-bit long) access to the
