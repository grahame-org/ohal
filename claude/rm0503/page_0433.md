...
3. Choose a calibration mode (refer to *Table 97: Operating modes and calibration*). The
...
*Note:*
*CALOUT switches from 0 to 1 for offset cal high and from 1 to 0 for offset cal low.*

*Note:*
*Between the write to the OPAMP_OTR register and the read of the CALOUT value, make*
*sure to wait for the t **OFFTRIM **max delay specified in the electrical characteristics section of*
...
*output must not pull up or down currents higher than 500 μA.*
