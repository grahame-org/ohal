...
the usart*ker_ck clock source can be configurable in the RCC (see \_Section : Reset and*
...
USART*CR1 register either to 16 or 8 times the baud rate clock (see \_Figure 333* and
_Figure 334_).

Depending on the application:

- select oversampling by 8 (OVER8 = 1) to achieve higher speed (up to
  usart*ker_ck_pres/8). In this case the maximum receiver tolerance to clock deviation is
  reduced (refer to \_Section 34.5.9: Tolerance of the USART receiver to clock deviation*)
