...
the usart*ker_ck clock source can be configurable in the RCC (see \_Section : Reset and Clock Control (RCC)*). Otherwise the usart_ker_ck clock is the same as usart_pclk.
