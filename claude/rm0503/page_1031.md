...
USART_CR1 register either to 16 or 8 times the baud rate clock (see *Figure 333* and
*Figure 334*).
...
- select oversampling by 8 (OVER8 = 1) to achieve higher speed (up to
  ...
  reduced (refer to *Section 34.5.9: Tolerance of the USART receiver to clock deviation*)
