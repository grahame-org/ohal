...
The choice of the clock source is done through the Clock Control system (see _Section : Reset and Clock Control (RCC)_). The clock source must be selected through the UE bit
...
the usart_ker_ck clock source can be configurable in the RCC (see _Section : Reset and Clock Control (RCC)_). Otherwise the usart_ker_ck clock is the same as usart_pclk.
