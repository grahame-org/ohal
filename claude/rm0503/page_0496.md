...
_Note: Interrupts are generated only when RNG is enabled._
...
_Note: When CLKDIV is different from zero, f \_\_RNG \*\*must take into account the internal divider ratio._
