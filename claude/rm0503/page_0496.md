...
Dedicated interrupt enable control bits are available as shown in *Table 113*.
...
In recommended configuration A or C described in *Table 115*, the time between two sets of
...
*Section 21.6: RNG entropy source validation*.

*Note:*
*When CLKDIV is different from zero, f **RNG **must take into account the internal divider ratio.*
