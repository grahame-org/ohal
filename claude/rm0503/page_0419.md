...
The PWRMODE[1:0] bitfileds of the COMPx_CSR registers allow setting the comparators to
high speed with full power or medium speed with medium power. Refer to _Section 17.6:_
_COMP registers_.
