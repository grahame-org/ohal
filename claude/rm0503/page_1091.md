...
_Note:_ _When the RXFTCFG[2:0] threshold is configured to 101, the RXFT flag is set if_
...
_Note:_ _If the USART does not support the smartcard mode, this bit is reserved and kept at_
