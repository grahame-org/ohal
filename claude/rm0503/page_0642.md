...
register and B \_K2BID, BKBID, BK2DSRM, BKDSRM, BK2P, BK2E, BK2F[3:0], BKF[3:0],*
_AOE, BKP, BKE, OSSI, OSSR and DTG[7:0]_ bits in TIMx*BDTR register can no longer
be written.
...
\_Note:* _The LOCK bits can be written only once after the reset. Once the TIMx_BDTR register_
