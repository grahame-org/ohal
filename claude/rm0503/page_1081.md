...
\_Note:_ \_If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to **Section 34.4: USART implementation**._
