...
ENULP bit in _Power control register 3 (PWR_CR3)_. When sampling mode is selected, fast
...
selected by the PLS[2:0] bits in the _Power control register 2 (PWR_CR2)_.

The PVD is enabled by setting the PVDE bit.

A PVDO flag is available, in the _Power status register 2 (PWR_SR2)_, to indicate if VDD is
