...
_Note: If the channel x is disabled, the DMA registers are not reset. The DMA channel registers_
\*(DMA*CCRx, DMA_CPARx and DMA_CMARx) retain the initial values programmed during the channel configuration phase.*
