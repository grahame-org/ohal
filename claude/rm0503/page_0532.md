...
_Note:_
_The header phase can be skipped if there is no associated data, that is, Len(A) = 0._

_The first block of the associated data (B1) must be formatted by software, with the_
_associated data length._
