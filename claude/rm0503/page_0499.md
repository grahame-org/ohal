...
value documented in Section 21.6: RNG entropy source validation.
...
consumption is critical. See Section 21.3.8: RNG low-power use. Refer to the
...
1: Custom values for NIST compliant RNG. See Section 21.6: RNG entropy source
...
management of noise source errors, as described in Section 21.3.7: Error management.
Writing this bit is taken into account only if CONDRST bit is set to 1 in the same access,
while CONFIGLOCK remains at 0. Writing to this bit is ignored if CONFIGLOCK = 1.
