...
\_Note:* \_WUFIE must be set before entering in low-power mode. If the _LPUART_does not support the wake-up from Stop feature, this bit is reserved and must be kept at reset value. Refer to **Section 35.3: LPUART implementation**._
...
_Note:_ \_If the _LPUART_does not support the wake-up from Stop feature, this bit is reserved and must be kept at reset value. Refer to **Section 35.3: LPUART implementation**._
