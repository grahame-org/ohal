...
code). It is based on GCM algorithm, as defined in NIST _Special Publication 800-38D,_
_Recommendation for Block Cipher Modes of Operation - Galois/Counter Mode (GCM) and_
_GMAC._
