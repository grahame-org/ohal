...
\_Note:_ \_This bit is significant on devices integrating the corresponding peripheral, otherwise it is reserved. Refer to **Section 1.5: Availability of peripherals**.\*
