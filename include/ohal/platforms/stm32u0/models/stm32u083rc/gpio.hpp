...
template <>
struct Pin<PortD, 0> : detail::NotBondedRc {}; ///< PD0  not bonded (RC)
template <>
struct Pin<PortD, 1> : detail::NotBondedRc {}; ///< PD1  not bonded (RC)
// PD2 is bonded out — no override, uses the partial specialisation above.
template <>
struct Pin<PortD, 3> : detail::NotBondedRc {}; ///< PD3  not bonded (RC)
template <>
struct Pin<PortD, 4> : detail::NotBondedRc {}; ///< PD4  not bonded (RC)
template <>
struct Pin<PortD, 5> : detail::NotBondedRc {}; ///< PD5  not bonded (RC)
template <>
struct Pin<PortD, 6> : detail::NotBondedRc {}; ///< PD6  not bonded (RC)
template <>
struct Pin<PortD, 7> : detail::NotBondedRc {}; ///< PD7  not bonded (RC)
template <>
struct Pin<PortD, 8> : detail::NotBondedRc {}; ///< PD8  not bonded (RC)
template <>
struct Pin<PortD, 9> : detail::NotBondedRc {}; ///< PD9  not bonded (RC)
template <>
struct Pin<PortD, 10> : detail::NotBondedRc {}; ///< PD10 not bonded (RC)
template <>
struct Pin<PortD, 11> : detail::NotBondedRc {}; ///< PD11 not bonded (RC)
template <>
struct Pin<PortD, 12> : detail::NotBondedRc {}; ///< PD12 not bonded (RC)
template <>
struct Pin<PortD, 13> : detail::NotBondedRc {}; ///< PD13 not bonded (RC)
template <>
struct Pin<PortD, 14> : detail::NotBondedRc {}; ///< PD14 not bonded (RC)
template <>
struct Pin<PortD, 15> : detail::NotBondedRc {}; ///< PD15 not bonded (RC)

// GPIOF: only PF0–PF3 are bonded out on the STM32U083RC 64-pin packages.
// Bits 4–15 are absent on these packages.
template <>
struct Pin<PortF, 4> : detail::NotBondedRc {}; ///< PF4  not bonded (RC)
template <>
struct Pin<PortF, 5> : detail::NotBondedRc {}; ///< PF5  not bonded (RC)
template <>
struct Pin<PortF, 6> : detail::NotBondedRc {}; ///< PF6  not bonded (RC)
template <>
struct Pin<PortF, 7> : detail::NotBondedRc {}; ///< PF7  not bonded (RC)
template <>
struct Pin<PortF, 8> : detail::NotBondedRc {}; ///< PF8  not bonded (RC)
template <>
struct Pin<PortF, 9> : detail::NotBondedRc {}; ///< PF9  not bonded (RC)
template <>
struct Pin<PortF, 10> : detail::NotBondedRc {}; ///< PF10 not bonded (RC)
template <>
struct Pin<PortF, 11> : detail::NotBondedRc {}; ///< PF11 not bonded (RC)
template <>
struct Pin<PortF, 12> : detail::NotBondedRc {}; ///< PF12 not bonded (RC)
template <>
struct Pin<PortF, 13> : detail::NotBondedRc {}; ///< PF13 not bonded (RC)
template <>
struct Pin<PortF, 14> : detail::NotBondedRc {}; ///< PF14 not bonded (RC)
template <>
struct Pin<PortF, 15> : detail::NotBondedRc {}; ///< PF15 not bonded (RC)
