...
template <>
struct Pin<PortC, 0> : detail::NotBondedCc {}; ///< PC0  not bonded (CC)
template <>
struct Pin<PortC, 1> : detail::NotBondedCc {}; ///< PC1  not bonded (CC)
template <>
struct Pin<PortC, 2> : detail::NotBondedCc {}; ///< PC2  not bonded (CC)
template <>
struct Pin<PortC, 3> : detail::NotBondedCc {}; ///< PC3  not bonded (CC)
template <>
struct Pin<PortC, 4> : detail::NotBondedCc {}; ///< PC4  not bonded (CC)
template <>
struct Pin<PortC, 5> : detail::NotBondedCc {}; ///< PC5  not bonded (CC)
template <>
struct Pin<PortC, 6> : detail::NotBondedCc {}; ///< PC6  not bonded (CC)
template <>
struct Pin<PortC, 7> : detail::NotBondedCc {}; ///< PC7  not bonded (CC)
template <>
struct Pin<PortC, 8> : detail::NotBondedCc {}; ///< PC8  not bonded (CC)
template <>
struct Pin<PortC, 9> : detail::NotBondedCc {}; ///< PC9  not bonded (CC)
template <>
struct Pin<PortC, 10> : detail::NotBondedCc {}; ///< PC10 not bonded (CC)
template <>
struct Pin<PortC, 11> : detail::NotBondedCc {}; ///< PC11 not bonded (CC)
template <>
struct Pin<PortC, 12> : detail::NotBondedCc {}; ///< PC12 not bonded (CC)
...
template <>
struct Pin<PortF, 4> : detail::NotBondedCc {}; ///< PF4  not bonded (CC)
template <>
struct Pin<PortF, 5> : detail::NotBondedCc {}; ///< PF5  not bonded (CC)
template <>
struct Pin<PortF, 6> : detail::NotBondedCc {}; ///< PF6  not bonded (CC)
template <>
struct Pin<PortF, 7> : detail::NotBondedCc {}; ///< PF7  not bonded (CC)
template <>
struct Pin<PortF, 8> : detail::NotBondedCc {}; ///< PF8  not bonded (CC)
template <>
struct Pin<PortF, 9> : detail::NotBondedCc {}; ///< PF9  not bonded (CC)
template <>
struct Pin<PortF, 10> : detail::NotBondedCc {}; ///< PF10 not bonded (CC)
template <>
struct Pin<PortF, 11> : detail::NotBondedCc {}; ///< PF11 not bonded (CC)
template <>
struct Pin<PortF, 12> : detail::NotBondedCc {}; ///< PF12 not bonded (CC)
template <>
struct Pin<PortF, 13> : detail::NotBondedCc {}; ///< PF13 not bonded (CC)
template <>
struct Pin<PortF, 14> : detail::NotBondedCc {}; ///< PF14 not bonded (CC)
template <>
struct Pin<PortF, 15> : detail::NotBondedCc {}; ///< PF15 not bonded (CC)
