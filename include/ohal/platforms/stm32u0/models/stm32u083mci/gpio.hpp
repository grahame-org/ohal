...
template <>
struct Pin<PortE, 0> : detail::NotBondedMci {}; ///< PE0  not bonded (MCI)
template <>
struct Pin<PortE, 1> : detail::NotBondedMci {}; ///< PE1  not bonded (MCI)
template <>
struct Pin<PortE, 2> : detail::NotBondedMci {}; ///< PE2  not bonded (MCI)
// PE3 is bonded out on the MCI (UFBGA81) — no override, uses the partial specialisation.
template <>
struct Pin<PortE, 4> : detail::NotBondedMci {}; ///< PE4  not bonded (MCI)
template <>
struct Pin<PortE, 5> : detail::NotBondedMci {}; ///< PE5  not bonded (MCI)
template <>
struct Pin<PortE, 6> : detail::NotBondedMci {}; ///< PE6  not bonded (MCI)
// PE7, PE8, PE9 are bonded out — no override, uses the partial specialisation above.
template <>
struct Pin<PortE, 10> : detail::NotBondedMci {}; ///< PE10 not bonded (MCI)
template <>
struct Pin<PortE, 11> : detail::NotBondedMci {}; ///< PE11 not bonded (MCI)
template <>
struct Pin<PortE, 12> : detail::NotBondedMci {}; ///< PE12 not bonded (MCI)
template <>
struct Pin<PortE, 13> : detail::NotBondedMci {}; ///< PE13 not bonded (MCI)
template <>
struct Pin<PortE, 14> : detail::NotBondedMci {}; ///< PE14 not bonded (MCI)
template <>
struct Pin<PortE, 15> : detail::NotBondedMci {}; ///< PE15 not bonded (MCI)
