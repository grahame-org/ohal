...
template <>
struct Pin<PortB, 2> : detail::NotBondedK
{
}; ///< PB2  not bonded (K)
template <>
struct Pin<PortB, 8> : detail::NotBondedK
{
}; ///< PB8  not bonded (K)
template <>
struct Pin<PortB, 9> : detail::NotBondedK
{
}; ///< PB9  not bonded (K)
template <>
struct Pin<PortB, 10> : detail::NotBondedK
{
}; ///< PB10 not bonded (K)
template <>
struct Pin<PortB, 11> : detail::NotBondedK
{
}; ///< PB11 not bonded (K)
template <>
struct Pin<PortB, 12> : detail::NotBondedK
{
}; ///< PB12 not bonded (K)
template <>
struct Pin<PortB, 13> : detail::NotBondedK
{
}; ///< PB13 not bonded (K)
template <>
struct Pin<PortB, 14> : detail::NotBondedK
{
}; ///< PB14 not bonded (K)
template <>
struct Pin<PortB, 15> : detail::NotBondedK
{
}; ///< PB15 not bonded (K)

// GPIOC: bits 0-13 absent on STM32U031K 32-pin packages.
template <>
struct Pin<PortC, 0> : detail::NotBondedK
{
}; ///< PC0  not bonded (K)
template <>
struct Pin<PortC, 1> : detail::NotBondedK
{
}; ///< PC1  not bonded (K)
template <>
struct Pin<PortC, 2> : detail::NotBondedK
{
}; ///< PC2  not bonded (K)
template <>
struct Pin<PortC, 3> : detail::NotBondedK
{
}; ///< PC3  not bonded (K)
template <>
struct Pin<PortC, 4> : detail::NotBondedK
{
}; ///< PC4  not bonded (K)
template <>
struct Pin<PortC, 5> : detail::NotBondedK
{
}; ///< PC5  not bonded (K)
template <>
struct Pin<PortC, 6> : detail::NotBondedK
{
}; ///< PC6  not bonded (K)
template <>
struct Pin<PortC, 7> : detail::NotBondedK
{
}; ///< PC7  not bonded (K)
template <>
struct Pin<PortC, 8> : detail::NotBondedK
{
}; ///< PC8  not bonded (K)
template <>
struct Pin<PortC, 9> : detail::NotBondedK
{
}; ///< PC9  not bonded (K)
template <>
struct Pin<PortC, 10> : detail::NotBondedK
{
}; ///< PC10 not bonded (K)
template <>
struct Pin<PortC, 11> : detail::NotBondedK
{
}; ///< PC11 not bonded (K)
template <>
struct Pin<PortC, 12> : detail::NotBondedK
{
}; ///< PC12 not bonded (K)
template <>
struct Pin<PortC, 13> : detail::NotBondedK
{
}; ///< PC13 not bonded (K)

// GPIOF: bits 0-1, 4-15 absent on STM32U031K 32-pin packages.
template <>
struct Pin<PortF, 0> : detail::NotBondedK
{
}; ///< PF0  not bonded (K)
template <>
struct Pin<PortF, 1> : detail::NotBondedK
{
}; ///< PF1  not bonded (K)
template <>
struct Pin<PortF, 4> : detail::NotBondedK
{
}; ///< PF4  not bonded (K)
template <>
struct Pin<PortF, 5> : detail::NotBondedK
{
}; ///< PF5  not bonded (K)
template <>
struct Pin<PortF, 6> : detail::NotBondedK
{
}; ///< PF6  not bonded (K)
template <>
struct Pin<PortF, 7> : detail::NotBondedK
{
}; ///< PF7  not bonded (K)
template <>
struct Pin<PortF, 8> : detail::NotBondedK
{
}; ///< PF8  not bonded (K)
template <>
struct Pin<PortF, 9> : detail::NotBondedK
{
}; ///< PF9  not bonded (K)
template <>
struct Pin<PortF, 10> : detail::NotBondedK
{
}; ///< PF10 not bonded (K)
template <>
struct Pin<PortF, 11> : detail::NotBondedK
{
}; ///< PF11 not bonded (K)
template <>
struct Pin<PortF, 12> : detail::NotBondedK
{
}; ///< PF12 not bonded (K)
template <>
struct Pin<PortF, 13> : detail::NotBondedK
{
}; ///< PF13 not bonded (K)
template <>
struct Pin<PortF, 14> : detail::NotBondedK
{
}; ///< PF14 not bonded (K)
template <>
struct Pin<PortF, 15> : detail::NotBondedK
{
}; ///< PF15 not bonded (K)
