#ifndef OHAL_PLATFORMS_MSP430FR2XX_MODELS_MSP430FR2355TRHA_CAPABILITIES_HPP
#define OHAL_PLATFORMS_MSP430FR2XX_MODELS_MSP430FR2355TRHA_CAPABILITIES_HPP

// This header is standalone to avoid partial-specialisation redefinition.
// MSP430FR2355TRHA (VQFN40):
//   PortA-D (P1-P4): all 8 bits bonded.
//   PortE (P5):       bits 0-1 bonded.
//   PortF (P6):       bits 0-1 bonded.
...
inline constexpr uint8_t kTrhaPortEFBitCount = 2U; ///< P5/P6: bits 0-1 only on VQFN40

template <uint8_t PinNum>
using TrhaFullPortCapability =
    std::bool_constant<(PinNum < platforms::msp430fr2xx::msp430fr2355::kPinCount)>;

template <uint8_t PinNum>
using TrhaPortEFCapability = std::bool_constant<(PinNum < kTrhaPortEFBitCount)>;
} // namespace detail
...
#endif // OHAL_PLATFORMS_MSP430FR2XX_MODELS_MSP430FR2355TRHA_CAPABILITIES_HPP
